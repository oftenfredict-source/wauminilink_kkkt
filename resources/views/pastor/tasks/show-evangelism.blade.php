                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            ...
                            <p class="text-muted mb-0">Evangelism Leader Task</p>
                        </div>
    ...
    <div class="row">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6 mb-2">
                            ...
                            <span class="text-muted">{{ $task->evangelismLeader->name ?? 'N/A' }}</span>
                        </div>
                        @if($task->campus)
                        <div class="col-md-6 mb-2">
                            <strong>Campus:</strong><br>
                            <span class="text-muted">{{ $task->campus->name }}</span>
                        </div>
                        @endif
                        @if($task->community)
                        <div class="col-md-6 mb-2">
        ...
        <div class="col-md-4 mb-4">
            ...
            <div class="card border-0 shadow-sm">
                ...
                <div class="card-body">
                    <form action="{{ route('pastor.tasks.comment-evangelism', $task->id) }}" method="POST">
                        @csrf
                        <div class="mb-3">
