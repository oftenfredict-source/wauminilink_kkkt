            ...
            <div class="card border-0 shadow-sm">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <h1 class="h3 mb-0"><i class="fas fa-rings-wedding me-2 text-warning"></i>Pending Church Wedding Requests</h1>
                            <p class="text-muted mb-0">Review and approve church wedding requests</p>
                        </div>
                    </div>
                </div>
            </div>
