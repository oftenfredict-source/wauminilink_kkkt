            ...
            <div class="col-12">
                <div class="card border-0 shadow-sm">
                    <div class="card-header report-header-primary text-white">
                        <h5 class="mb-0"><i class="fas fa-clock me-2"></i>Pending Finalization ({{ $offerings->total() }})
                        </h5>
                    </div>
                    <div class="card-body">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @if($offering->service_type)
                                                        <span
                                                            class="badge bg-dark">{{ ucfirst(str_replace('_', ' ', $offering->service_type)) }}</span>
                                                    @else
                                                ...
                                                <td class="text-end">
                                                    <div class="btn-group btn-group-sm">
                                                        <a href="{{ route('secretary.offerings.show', $offering->id) }}"
                                                            class="btn btn-outline-danger" title="View Details">
                                                            <i class="fas fa-eye"></i>
                                                        </a>
                                                        <button type="button" class="btn btn-success"
                                                            onclick="finalizeOffering({{ $offering->id }})" title="Finalize">
                ...
                <div class="col-12">
                    <div class="card border-0 shadow-sm">
                        <div class="card-header bg-success text-white">
                            <h5 class="mb-0"><i class="fas fa-check-circle me-2"></i>Completed Offerings
                                ({{ $completedOfferings->total() }})</h5>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-hover">
