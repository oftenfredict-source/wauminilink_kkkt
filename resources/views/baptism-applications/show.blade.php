    ...
    <div class="container-fluid px-4">
                ...
                <div class="card border-0 shadow-sm">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                <h1 class="h3 mb-0"><i class="fas fa-water me-2 text-primary"></i>Baptism Application
                                    Details</h1>
                            ...
                            <div>
                                ...
                                @elseif(auth()->user()->isPastor() || auth()->user()->isAdmin())
                                    <a href="{{ route('pastor.baptism-applications.pending') }}"
                                        class="btn btn-outline-primary">
                                        <i class="fas fa-arrow-left me-1"></i> Back
                                    </a>
                                @endif
        ...
        <div class="row">
            ...
            <div class="col-md-8 mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 mb-2">
                                ...
                                <span class="text-muted">{{ $baptismApplication->place_of_birth ?? '-' }}</span>
                            </div>
                            <div class="col-md-3 mb-2">
                ...
                <!-- Spiritual Information (Adults Only) -->
                @if($baptismApplication->age >= 18)
                    <div class="card border-0 shadow-sm mb-3">
                        ...
                        <div class="card-body">
                            <div class="row mb-2">
                                <div class="col-md-6">
                                    ...
                                    <span
                                        class="badge bg-{{ $baptismApplication->previously_baptized ? 'warning' : 'success' }}">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <span
                                        class="badge bg-{{ $baptismApplication->attended_baptism_classes ? 'success' : 'warning' }}">
                                ...
                                <div class="row mb-2">
                                    ...
                                    @if($baptismApplication->previous_baptism_date)
                                        <div class="col-md-6">
                                            ...
                                            <span
                                                class="text-muted">{{ $baptismApplication->previous_baptism_date->format('F d, Y') }}</span>
                                        </div>
                                    @endif
                                </div>
                            @endif
                ...
                <!-- Family Information -->
                @if($baptismApplication->father_name || $baptismApplication->mother_name || $baptismApplication->family_religious_background || $baptismApplication->age < 18)
                    <div class="card border-0 shadow-sm mb-3">
                        <div class="card-header bg-info text-white">
                            <h5 class="mb-0">
                                <i class="fas fa-users me-2"></i>Family Information
                                @if($baptismApplication->age < 18)
                                    <span class="badge bg-warning text-dark ms-2">Child Applicant - Certificate Details
                                        Required</span>
                                @endif
                            </h5>
                        </div>
                        <div class="card-body">
                            @if($baptismApplication->age < 18 && (!$baptismApplication->father_name || !$baptismApplication->mother_name))
                                <div class="alert alert-warning mb-3">
                                    <i class="fas fa-exclamation-triangle me-2"></i>
                                    <strong>Warning:</strong> Father's and Mother's names are missing for this child applicant.
                                </div>
                            @endif
                            @if($baptismApplication->father_name || $baptismApplication->mother_name)
                                <div class="row mb-2">
                                    @if($baptismApplication->father_name)
                                        <div class="col-md-6">
                                            <strong>Father's Name:</strong><br>
                                            <span class="text-muted">{{ $baptismApplication->father_name }}</span>
                                        </div>
                                    @endif
                                    @if($baptismApplication->mother_name)
                                        <div class="col-md-6">
                                            <strong>Mother's Name:</strong><br>
                                            <span class="text-muted">{{ $baptismApplication->mother_name }}</span>
                                        </div>
                                    @endif
                                </div>
                            @endif
                            @if($baptismApplication->godparent1_name || $baptismApplication->godparent2_name)
                                <div class="row mb-2 mt-3">
                                    <div class="col-12">
                                        <h6 class="text-muted small text-uppercase">Wadhamini (Sponsors)</h6>
                                    </div>
                                    @if($baptismApplication->godparent1_name)
                                        <div class="col-md-6">
                                            <strong>Wadhamini 1:</strong><br>
                                            <span class="text-muted">{{ $baptismApplication->godparent1_name }}</span>
                                        </div>
                                    @endif
                                    @if($baptismApplication->godparent2_name)
                                        <div class="col-md-6">
                                            <strong>Wadhamini 2:</strong><br>
                                            <span class="text-muted">{{ $baptismApplication->godparent2_name }}</span>
                                        </div>
                                    @endif
                                </div>
                            @endif
                        ...
                        <div class="card-body">
                            @if($baptismApplication->photo_path)
                                <div class="mb-2">
                                    ...
                                    <a href="{{ asset('storage/' . $baptismApplication->photo_path) }}" target="_blank"
                            ...
                            @if($baptismApplication->recommendation_letter_path)
                                <div>
                                    ...
                                    <a href="{{ asset('storage/' . $baptismApplication->recommendation_letter_path) }}"
            ...
            <div class="col-md-4 mb-4">
                    ...
                    <div class="card-body">
                        ...
                        @if($baptismApplication->scheduled_baptism_date)
                            <div class="mb-3">
                                ...
                                <span
                                    class="text-success fw-bold">{{ $baptismApplication->scheduled_baptism_date->format('F d, Y') }}</span>
                            </div>
                        @endif
                ...
                @if((auth()->user()->isPastor() || auth()->user()->isAdmin()) && $baptismApplication->status === 'pending')
                    <div class="card border-0 shadow-sm">
                        ...
                        <div class="card-body">
                            <!-- Approve Form -->
                            <form action="{{ route('pastor.baptism-applications.approve', $baptismApplication->id) }}"
                                method="POST" class="mb-3">
                                @csrf
                                <div class="mb-2">
                                    <label for="scheduled_baptism_date" class="form-label small">Schedule Baptism Date
                                        (Optional)</label>
                            ...
                            <!-- Reject Form -->
                            <form action="{{ route('pastor.baptism-applications.reject', $baptismApplication->id) }}"
                                method="POST" onsubmit="return confirm('Are you sure you want to reject this application?');">
                                @csrf
                                <div class="mb-2">
                                    <label for="pastor_comments_reject" class="form-label small">Rejection Reason <span
                                            class="text-danger">*</span></label>
                                    <textarea
                                        class="form-control form-control-sm @error('pastor_comments') is-invalid @enderror"
                ...
                @if((auth()->user()->isPastor() || auth()->user()->isAdmin()) && $baptismApplication->status === 'approved')
                    <div class="card border-0 shadow-sm mt-3">
                        ...
                        <div class="card-body">
                            <form action="{{ route('pastor.baptism-applications.schedule', $baptismApplication->id) }}"
                                method="POST">
                                @csrf
                                <div class="mb-2">
                                    <label for="scheduled_date" class="form-label small">Baptism Date <span
                                            class="text-danger">*</span></label>
                ...
                @if((auth()->user()->isPastor() || auth()->user()->isAdmin()) && $baptismApplication->status === 'scheduled')
                    <div class="card border-0 shadow-sm mt-3">
                        <div class="card-body">
                            <form action="{{ route('pastor.baptism-applications.complete', $baptismApplication->id) }}"
                                method="POST" onsubmit="return confirm('Mark this baptism as completed?');">
                                @csrf
