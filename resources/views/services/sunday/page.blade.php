...
@section('content')
    ...
    <div class="container-fluid px-4">
        <div class="d-flex flex-wrap align-items-center justify-content-between mt-4 mb-3 gap-2 page-header-mobile">
            ...
            <div class="d-flex flex-wrap gap-2 btn-group-mobile">
                ...
                <a href="{{ route('services.sunday.export.csv', request()->query()) }}"
        ...
        <form method="GET" action="{{ route('services.sunday.index') }}" class="card mb-3 border-0 shadow-sm"
            id="filtersForm">
            <!-- Filter Header -->
                    ...
                    <div class="d-flex align-items-center gap-2">
                        ...
                        @if(request('search') || request('from') || request('to'))
                            <span class="badge bg-primary rounded-pill"
                                id="activeFiltersCount">{{ (request('search') ? 1 : 0) + (request('from') ? 1 : 0) + (request('to') ? 1 : 0) }}</span>
                        @endif
                    </div>
            ...
            <div class="card-body p-3" id="filterBody">
                <div class="row g-2 mb-2">
                    ...
                    <div class="col-12 col-md-4">
                        ...
                        <input type="text" name="search" value="{{ request('search') }}"
                            class="form-control form-control-sm" placeholder="Search theme, preacher, venue">
                    </div>
                ...
                <div class="d-flex gap-2 flex-wrap">
                    <a href="{{ route('services.sunday.index') }}"
        ...
        <div class="card">
                        ...
                        <tbody>
                            @forelse($services as $service)
                                <tr id="row-{{ $service->id }}">
                                    ...
                                    <td><span
                                            class="badge bg-secondary">{{ optional($service->service_date)->format('d/m/Y') }}</span>
                                    </td>
                                    <td>
                                        @php
                                            $serviceTypeLabels = [
                                        ...
                                        @endphp
                                        <span
                                            class="badge bg-primary">{{ $serviceTypeLabels[$service->service_type] ?? ucfirst(str_replace('_', ' ', $service->service_type)) }}</span>
                                    </td>
                                    <td>{{ $service->theme ?? '—' }}</td>
                                    ...
                                    <td class="text-end">
                                        <div class="btn-group btn-group-sm" role="group">
                                            ...
                                            <button class="btn btn-outline-primary"
                                                onclick="openEditService({{ $service->id }})" title="Edit">
                                                <i class="fas fa-edit"></i>
                                            </button>
                                            <button class="btn btn-outline-danger"
                                                onclick="confirmDeleteService({{ $service->id }})" title="Delete">
            ...
            <div class="card-footer d-flex justify-content-between align-items-center flex-wrap">
                <div class="text-muted small mb-2 mb-md-0">Showing {{ $services->firstItem() }} to
                    {{ $services->lastItem() }} of {{ $services->total() }} entries
                </div>
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6 col-12">
                                <label class="form-label service-label mb-2">
                                    <i class="fas fa-church me-1 text-primary"></i>Service Type <span
                            ...
                            <div class="col-md-6 col-12" id="svc_other_service_wrapper" style="display: none;">
                                ...
                                <input type="text" class="form-control service-input" id="svc_other_service"
                            ...
                            <div class="col-md-6 col-12">
                                ...
                                <input type="text" class="form-control service-input" id="svc_theme"
                            ...
                            <div class="col-md-4 col-12">
                                <label class="form-label service-label mb-2">
                                    <i class="fas fa-calendar-alt me-1 text-info"></i>Date <span
                                        class="text-danger">*</span>
                                </label>
                            ...
                            <div class="col-md-6 col-12">
                                ...
                                <input type="text" class="form-control service-input mt-2" id="svc_preacher_custom"
                                    placeholder="Or type custom preacher name..." style="display: none;">
                            </div>
                            <div class="col-md-6 col-12">
                                <label class="form-label service-label mb-2">
                            ...
                            <div class="col-md-6 col-12">
                                ...
                                <input type="text" class="form-control service-input" id="svc_venue"
                            ...
                            <div class="col-md-3 col-6">
                                ...
                                <input type="text" class="form-control service-input" id="svc_choir"
                                    placeholder="Choir name">
                            </div>
                            <div class="col-md-3 col-6">
                                <label class="form-label service-label mb-2">
                                    <i class="fas fa-users me-1 text-info"></i>Registered Members <small
                                        class="text-muted">(Optional)</small>
                                </label>
                                <input type="number" min="0" class="form-control service-input" id="svc_attendance"
                                    placeholder="Count">
                            </div>
                            <div class="col-md-3 col-6">
                                <label class="form-label service-label mb-2">
                                    <i class="fas fa-user-plus me-1 text-primary"></i>Guests <small
                                        class="text-muted">(Optional)</small>
                                </label>
                                <input type="number" min="0" class="form-control service-input" id="svc_guests"
                                    placeholder="Count">
                            </div>
                            <div class="col-md-3 col-6">
                                <label class="form-label service-label mb-2">
                                    <i class="fas fa-coins me-1 text-success"></i>Offerings <small
                                        class="text-muted">(Optional)</small>
                                </label>
                                <input type="number" min="0" step="0.01" class="form-control service-input"
                                    id="svc_offerings" placeholder="TZS">
                            </div>
                            ...
                            <div class="col-12">
                                ...
                                <textarea class="form-control service-input" id="svc_readings" rows="2"
                                    placeholder="Enter scripture readings"></textarea>
                            </div>
                            ...
                            <div class="col-12">
                                ...
                                <textarea class="form-control service-input" id="svc_notes" rows="2"
        ...
        <div class="modal-dialog modal-lg modal-dialog-scrollable">
            <div class="modal-content border-0 shadow-lg" style="border-radius: 18px; overflow: hidden;">
                <div class="modal-header text-white"
                    ...
                    <h5 class="modal-title d-flex align-items-center gap-2"><i class="fas fa-info-circle"></i><span>Service
                            Details</span></h5>
                ...
                <div class="modal-footer d-flex justify-content-between align-items-center">
                    <div class="small"><span class="me-1">Powered by</span><a href="https://emca.tech/#" target="_blank"
                            rel="noopener" class="emca-link fw-semibold" style="color: #940000 !important;">EmCa
                            Technologies</a></div>
                    ...
                    <form id="editServiceForm">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6" id="edit_other_service_wrapper" style="display: none;">
                                ...
                                <input type="text" class="form-control service-input" id="edit_other_service"
                                    placeholder="Enter service type">
                            </div>
                            <div class="col-md-6 col-12">
                                <label class="form-label service-label mb-2">
                                ...
                                <input type="text" class="form-control service-input" id="edit_theme"
                                    placeholder="Service theme">
                            </div>
                            ...
                            <div class="col-md-6 col-12">
                                ...
                                <input type="text" class="form-control service-input mt-2" id="edit_preacher_custom"
                                    placeholder="Or type custom preacher name..." style="display: none;">
                            </div>
                            <div class="col-md-6 col-12">
                                <label class="form-label service-label mb-2">
                            ...
                            <div class="col-md-6 col-12">
                                ...
                                <input type="text" class="form-control service-input" id="edit_venue"
                                    placeholder="Venue location">
                            </div>
                            ...
                            <div class="col-md-3 col-6">
                                ...
                                <input type="text" class="form-control service-input" id="edit_choir"
                                    placeholder="Choir name">
                            </div>
                            <div class="col-md-3 col-6">
                                <label class="form-label service-label mb-2">
                                ...
                                <input type="number" min="0" class="form-control service-input" id="edit_attendance"
                                    placeholder="Count">
                            </div>
                            <div class="col-md-3 col-6">
                                <label class="form-label service-label mb-2">
                                ...
                                <input type="number" min="0" class="form-control service-input" id="edit_guests"
                                    placeholder="Count">
                            </div>
                            <div class="col-md-3 col-6">
                                <label class="form-label service-label mb-2">
                                ...
                                <input type="number" min="0" step="0.01" class="form-control service-input"
                                    id="edit_offerings" placeholder="TZS">
                            </div>
                            ...
                            <div class="col-12">
                                ...
                                <textarea class="form-control service-input" id="edit_readings" rows="2"
                                    placeholder="Enter scripture readings"></textarea>
                            </div>
                            ...
                            <div class="col-12">
                                ...
                                <textarea class="form-control service-input" id="edit_notes" rows="2"
                                    placeholder="Additional notes"></textarea>
                            </div>
                        </div>
    ...
    <script>
        ...
        // Modal and Field Status Logic
        const addServiceModal = document.getElementById('addServiceModal');
        const editServiceModal = document.getElementById('editServiceModal');

        // Function to update field status based on service time
        function updateFieldsStatus(dateId, timeId, fieldIds) {
            ...
            const scheduledDateTime = dateValue ? new Date(`${dateValue}T${timeValue}`) : null;
            const now = new Date();
            ...
            fieldIds.forEach(id => {
                ...
                if (!dateValue) {
                    field.disabled = true;
                    field.title = "Please select a service date first";
                } else if (scheduledDateTime && now < scheduledDateTime) {
                    field.disabled = true;
                    field.title = "This data can only be entered after the service has started";
                } else {
        ...
        // Store current edit data globally for restoration
        let currentEditServiceData = null;

        // Handle Add Service modal events
        if (addServiceModal) {
            addServiceModal.addEventListener('show.bs.modal', function () {
                ...
                Promise.all([
                    ...
                    const svcDateInput = document.getElementById('svc_date');
                    if (svcDateInput && svcDateInput.value) {
                        setTimeout(() => checkWeeklyAssignmentForDate(svcDateInput.value), 300);
                    }
            ...
            addServiceModal.addEventListener('shown.bs.modal', function () {
                ...
                const svcDateInput = document.getElementById('svc_date');
                if (svcDateInput && svcDateInput.value) {
                    setTimeout(() => checkWeeklyAssignmentForDate(svcDateInput.value), 500);
                }
            ...
            // Initialize field lock logic for Add modal
            const svcDate = document.getElementById('svc_date');
            const svcTime = document.getElementById('svc_start');
            const addFieldIds = ['svc_attendance', 'svc_guests', 'svc_offerings'];

            if (svcDate && svcTime) {
                const updateSvcStatus = () => updateFieldsStatus('svc_date', 'svc_start', addFieldIds);
                svcDate.addEventListener('change', updateSvcStatus);
                svcTime.addEventListener('change', updateSvcStatus);
                addServiceModal.addEventListener('shown.bs.modal', updateSvcStatus);
                setInterval(() => { if (addServiceModal.classList.contains('show')) updateSvcStatus(); }, 30000);
            }
        }

        // Handle Edit Service modal events
        if (editServiceModal) {
                ...
                Promise.all([
                    ...
                    if (currentEditServiceData) {
                        if (currentEditServiceData.coordinator_id) {
                            const coordSelect = document.getElementById('edit_coordinator_id');
                            if (coordSelect) coordSelect.value = currentEditServiceData.coordinator_id;
                        }
                        if (currentEditServiceData.church_elder_id) {
                            const elderSelect = document.getElementById('edit_church_elder_id');
                            if (elderSelect) elderSelect.value = currentEditServiceData.church_elder_id;
                        }
                        if (currentEditServiceData.preacher) {
                            ...
                            if (preacherSelect) {
                                const option = Array.from(preacherSelect.options).find(opt => opt.value === currentEditServiceData.preacher);
                                if (option) {
            ...
            // Initialize field lock logic for Edit modal
            const editDate = document.getElementById('edit_date');
            const editTime = document.getElementById('edit_start');
            const editFieldIds = ['edit_attendance', 'edit_guests', 'edit_offerings'];

            if (editDate && editTime) {
                const updateEditStatus = () => updateFieldsStatus('edit_date', 'edit_start', editFieldIds);
                editDate.addEventListener('change', updateEditStatus);
                editTime.addEventListener('change', updateEditStatus);
                editServiceModal.addEventListener('shown.bs.modal', updateEditStatus);
                setInterval(() => { if (editServiceModal.classList.contains('show')) updateEditStatus(); }, 30000);
            }
        }
            ...
            Swal.fire({ title: 'Delete service?', text: 'This action cannot be undone.', icon: 'warning', showCancelButton: true, confirmButtonText: 'Yes, delete', cancelButtonText: 'Cancel', confirmButtonColor: '#dc3545' })
                .then((result) => {
                    if (result.isConfirmed) {
                        fetch(`{{ url('/services/sunday') }}/${id}`, { method: 'DELETE', headers: { 'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content') } })
                            .then(r => r.json())
