            ...
            <div class="mt-3 mt-md-0">
                ...
                @if($memberId)
                    @if(isset($member->membership_type) && $member->membership_type === 'temporary')
                        <button onclick="confirmExtension({{ $memberId }})" class="btn btn-info btn-sm shadow-sm me-2 text-white">
                            <i class="fas fa-clock me-1"></i> {{ __('common.extend') }}
                        </button>
                    @endif
                    <a href="{{ route('members.edit', $memberId) }}" class="btn btn-light btn-sm shadow-sm me-2 text-primary fw-bold">
        ...
        <div class="card-body bg-light px-4 py-4">
            ...
            <div class="alert alert-info d-flex align-items-center mb-4">
                ...
                <div>
                    ...
                    <p class="mb-0">
                        ...
                        {{ __('common.duration') }}: <strong>{{ $member->membership_duration_months ?? __('common.no_data') }} {{ __('common.months') }}</strong>.
                        {{ __('common.end_date') }}: <strong>{{ $member->membership_end_date ? \Carbon\Carbon::parse($member->membership_end_date)->format('M d, Y') : __('common.no_data') }}</strong>.
                        {{ __('common.status') }}: <span class="badge bg-{{ ($member->membership_status ?? 'active') === 'active' ? 'success' : 'warning' }}">{{ $member->membership_status ? __('common.' . $member->membership_status) : __('common.active') }}</span>
                    </p>
                </div>
            </div>
            @endif
            ...
            <div class="row g-4">
                ...
                <div class="col-12">
                    <div class="card border-0 shadow-sm">
                        <div class="card-header bg-primary text-white py-3">
                            <h5 class="mb-0"><i class="fas fa-user me-2"></i>{{ __('common.personal_information') }}</h5>
                        </div>
                        <div class="card-body">
                            <div class="row g-3">
                                ...
                                <div class="col-md-9">
                                    <div class="row g-3">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <p class="fw-bold">
                                                @if($member->envelope_number)
                                                    <span class="badge bg-success shadow-sm px-3">{{ $member->envelope_number }}</span>
                                                @else
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <p class="fw-bold text-capitalize">{{ $member->gender ? __('common.' . $member->gender) : __('common.no_data') }}</p>
                                        </div>
                                        <div class="col-md-6">
                                            <label class="text-muted small">{{ __('common.date_of_birth') }}</label>
                                            <p class="fw-bold">{{ $member->date_of_birth ? \Carbon\Carbon::parse($member->date_of_birth)->format('M d, Y') : __('common.no_data') }}</p>
                                        </div>
                                        <div class="col-md-6">
                                            <label class="text-muted small">{{ __('common.membership_type') }}</label>
                                            <p class="fw-bold text-capitalize">{{ $member->membership_type ? __('common.' . $member->membership_type) : __('common.no_data') }}</p>
                                        </div>
                                        <div class="col-md-6">
                                            <label class="text-muted small">{{ __('common.member_type') }}</label>
                                            <p class="fw-bold text-capitalize">{{ $member->member_type ? __('common.' . $member->member_type) : __('common.no_data') }}</p>
                                        </div>
                                        <div class="col-md-6">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <p class="fw-bold">{{ $member->community->name ?? __('common.no_data') }}</p>
                                        </div>
                                        <div class="col-md-6">
                ...
                <div class="col-12">
                    <div class="card border-0 shadow-sm">
                        <div class="card-header bg-primary text-white py-3">
                            <h5 class="mb-0"><i class="fas fa-layer-group me-2"></i>{{ __('common.church_departments') }}</h5>
                        </div>
                        <div class="card-body">
                                            ...
                                            @foreach($departmentStatus as $status)
                                                <tr>
                                                    <td>
                                                        ...
                                                        <div class="small text-muted">{{ \Illuminate\Support\Str::limit($status['department']->description, 50) }}</div>
                                                    </td>
                                                    <td>
                                                        @if($status['assigned'])
                                                            <span class="badge bg-success">{{ __('common.assigned') }}</span>
                                                        @else
                                                            <span class="badge bg-light text-muted border">{{ __('common.not_member') }}</span>
                                                        @endif
                                                    </td>
                                                    <td>
                                                        @if($status['eligible'])
                                                            <span class="badge bg-success bg-opacity-10 text-success">{{ __('common.eligible') }}</span>
                                                        @else
                                                            <span class="badge bg-danger bg-opacity-10 text-danger" title="{{ $status['reason'] }}">
                                                    ...
                                                    <td>
                                                        @if(!$status['assigned'])
                                                            @if($status['eligible'])
                                                                <form action="{{ route('departments.assign', $status['department']->id) }}" method="POST" class="d-inline">
                                                                    @csrf
                                                            ...
                                                            @else
                                                                <button class="btn btn-sm btn-outline-secondary rounded-pill px-3" disabled title="{{ $status['reason'] }}">
                                                                    <i class="fas fa-ban me-1"></i> {{ __('common.join') }}
                                                                </button>
                                                            @endif
                                                        @else
                                                            <form action="{{ route('departments.remove-member', [$status['department']->id, $member->id]) }}" method="POST" onsubmit="return confirm('{{ __('common.are_you_sure') }}?');" class="d-inline">
                                                                @csrf
                                                                @method('DELETE')
                                                                <button type="submit" class="btn btn-sm btn-outline-danger rounded-pill px-3">
                                                                    <i class="fas fa-sign-out-alt me-1"></i> {{ __('common.leave') }}
                                                                </button>
                                                            </form>
                                                        @endif
                                                    </td>
                ...
                <div class="col-12">
                    <div class="card border-0 shadow-sm">
                        <div class="card-header bg-primary text-white py-3">
                            <h5 class="mb-0"><i class="fas fa-phone me-2"></i>{{ __('common.contact_location_information') }}</h5>
                        </div>
                        <div class="card-body">
                            <div class="row g-3">
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <p class="fw-bold">{{ $member->tribe ?? __('common.no_data') }}{{ $member->other_tribe ? ' (' . $member->other_tribe . ')' : '' }}</p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card-body">
                            <div class="row g-3">
                                <div class="col-md-6">
                                    ...
                                    <p class="fw-bold text-capitalize">{{ $member->marital_status ? __('common.' . $member->marital_status) : __('common.no_data') }}</p>
                                </div>
                                    ...
                                    <div class="col-12">
                                        <h6 class="mt-3 mb-2">
                                            ...
                                            @elseif(empty($member->spouse_full_name) && empty($member->spouse_phone_number))
                                                <span class="badge bg-warning ms-2 text-dark">{{ __('common.no_spouse_information') }}</span>
                                            @else
                                        ...
                                        @if(empty($member->spouse_full_name) && empty($member->spouse_phone_number) && !isset($member->spouse_member_id))
                                            <div class="alert alert-info mb-3">
                                                ...
                                                <a href="{{ route('members.edit', $member->id) }}" class="alert-link">{{ __('common.click_to_add_spouse') }}</a>.
                                            </div>
                                        @endif
                                        <div class="row g-3">
                                            @php
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <p class="fw-bold">
                                                    @if($spouse)
                                                        ...
                                                        @if($spouse)
                                                            <a href="{{ route('members.show', $spouse->id) }}" class="btn btn-sm btn-outline-primary ms-2" title="{{ __('common.view_spouse_details') }}">
                                            ...
                                            @if($spouse)
                                                ...
                                                <div class="col-md-6">
                                                    <label class="text-muted small">{{ __('common.membership_type') }}</label>
                                                    <p class="fw-bold text-capitalize">{{ $spouse->membership_type ? __('common.' . $spouse->membership_type) : __('common.no_data') }}</p>
                                                </div>
                                            @endif
                                        </div>
                                    </div>
                                ...
                                @if(isset($member->member_type) && $member->member_type === 'independent' && (!isset($member->marital_status) || $member->marital_status !== 'married'))
                                    <div class="col-12">
                                        <h6 class="mt-3 mb-2"><i class="fas fa-user-shield me-2"></i>{{ __('common.guardian_responsible_info') }}</h6>
                                        <div class="row g-3">
                                            <div class="col-md-4">
                                                <label class="text-muted small">{{ __('common.name') }}</label>
                                                <p class="fw-bold">{{ !empty($member->guardian_name) ? $member->guardian_name : __('common.no_data') }}</p>
                                            </div>
                                            <div class="col-md-4">
                                                <label class="text-muted small">{{ __('common.phone_number') }}</label>
                                                <p class="fw-bold">{{ !empty($member->guardian_phone) ? $member->guardian_phone : __('common.no_data') }}</p>
                                            </div>
                                            <div class="col-md-4">
                                                <label class="text-muted small">{{ __('common.relationship') }}</label>
                                                <p class="fw-bold">{{ !empty($member->guardian_relationship) ? $member->guardian_relationship : __('common.no_data') }}</p>
                                            </div>
                                        </div>
                                    </div>
                                @endif
                ...
                <div class="col-12">
                    <div class="card border-0 shadow-sm">
                        <div class="card-header bg-danger text-white py-3">
                            <h5 class="mb-0"><i class="fas fa-hand-holding-heart me-2"></i>{{ __('common.social_welfare_status') }}</h5>
                        </div>
                        <div class="card-body">
                            <div class="row g-3">
                                <!-- Member Welfare Information -->
                                <div class="col-12">
                                    <h6 class="text-primary mb-3"><i class="fas fa-user me-2"></i>{{ __('common.member_welfare_information') }}</h6>
                                    <div class="row g-3">
                                        <div class="col-md-4">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <p class="fw-bold">
                                                @if(isset($member->disability_status) && $member->disability_status)
                                                    <span class="badge bg-warning text-dark">{{ __('common.has_disability') }}</span>
                                                    @if(!empty($member->disability_type))
                                                        <br><small class="text-muted">{{ __('common.type') }}: {{ $member->disability_type }}</small>
                                                    @endif
                                                @else
                                        ...
                                        <div class="col-md-4">
                                            <label class="text-muted small">{{ __('common.vulnerability_status') }}</label>
                                            <p class="fw-bold">
                                                @if(isset($member->vulnerable_status) && $member->vulnerable_status)
                                                    ...
                                                    @if(!empty($member->vulnerable_type))
                                                        <br><small class="text-muted">{{ __('common.type') }}: {{ $member->vulnerable_type }}</small>
                                                    @endif
                                                @else
                                ...
                                <div class="col-12">
                                    <hr class="my-3">
                                    <h6 class="text-primary mb-3"><i class="fas fa-heart me-2"></i>{{ __('common.spouse_welfare_information') }}</h6>
                                    <div class="row g-3">
                                        <div class="col-md-6">
                                            <label class="text-muted small">{{ __('common.spouse_orphan_status') }}</label>
                                            <p class="fw-bold">
                                                @php
                                        ...
                                        <div class="col-md-6">
                                            <label class="text-muted small">{{ __('common.spouse_disability_status') }}</label>
                                            <p class="fw-bold">
                                                @php
                                                ...
                                                @if($spouseDisabilityStatus)
                                                    ...
                                                    @if(!empty($spouseDisabilityType))
                                                        <br><small class="text-muted">{{ __('common.type') }}: {{ $spouseDisabilityType }}</small>
                                                    @endif
                                                @else
                                                    <span class="badge bg-success">{{ __('common.no_disability') }}</span>
                                                @endif
                ...
                <div class="col-12">
                    <div class="card border-0 shadow-sm">
                        <div class="card-header text-white py-3 d-flex justify-content-between align-items-center" style="background-color: #940000 !important;">
                            <h5 class="mb-0"><i class="fas fa-handshake me-2"></i>{{ __('common.ahadi_kwa_bwana') }} ({{ date('Y') }})</h5>
                            <button type="button" class="btn btn-light btn-sm rounded-pill px-3 fw-bold" style="color: #940000 !important; opacity: 1 !important;" data-bs-toggle="modal" data-bs-target="#addAhadiModal">
                                <i class="fas fa-plus me-1"></i> {{ __('common.record_new_ahadi') }}
                            </button>
                        </div>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                @elseif($pledge->status == 'partially_fulfilled')
                                                    <span class="badge bg-warning text-dark">{{ __('common.partially_fulfilled') }}</span>
                                                @else
                                                    <span class="badge bg-secondary">{{ __('common.promised') }}</span>
                                                @endif
                                            </td>
                                            <td class="text-end pe-3">
                                                <button class="btn btn-sm btn-outline-success rounded-pill px-3" onclick="openFulfillmentModal({{ json_encode($pledge) }})">
                                        ...
                                        <tr>
                                            <td colspan="6" class="text-center py-4 text-muted" style="height: 100px;">
                                                <i class="fas fa-info-circle me-2"></i>{{ __('common.no_kind_pledges_recorded') }} {{ date('Y') }}.
                                            </td>
                                        </tr>
                                        @endforelse
                                    </tbody>
                                ...
                                <table class="table table-hover mb-0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @if($child->disability_status)
                                                    ...
                                                    @if(!empty($child->disability_type))
                                                        <br><small class="text-muted">{{ __('common.type') }}: {{ $child->disability_type }}</small>
                                                    @endif
                                                @else
                                                    <span class="badge bg-success">{{ __('common.no_disability') }}</span>
                                                @endif
                                            ...
                                            <td>
                                                @if($child->vulnerable_status)
                                                    ...
                                                    @if(!empty($child->vulnerable_type))
                                                        <br><small class="text-muted">{{ __('common.type') }}: {{ $child->vulnerable_type }}</small>
                                                    @endif
                                                @else
                                                    <span class="badge bg-success">{{ __('common.not_vulnerable') }}</span>
                                                @endif
                                            ...
                                            <td class="text-end">
                                                <a href="{{ route('children.show', $child->id) }}" class="btn btn-sm btn-outline-primary rounded-pill px-3">
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header text-white" style="background-color: #940000 !important;">
                <h5 class="modal-title">{{ __('common.record_ahadi_kwa_bwana') }}</h5>
            ...
            <form action="{{ route('finance.ahadi-pledges.store') }}" method="POST">
                ...
                <div class="modal-body">
                    <div class="row g-3 mb-4">
                        <div class="col-md-6">
                            <label class="form-label fw-bold">{{ __('common.member') }}</label>
                            <input type="text" class="form-control" value="{{ $member->full_name }}" readonly>
                        </div>
                        <div class="col-md-6">
                            <label class="form-label fw-bold">{{ __('common.year') }}</label>
                            <input type="number" class="form-control" name="year" value="{{ date('Y') }}" required>
                        </div>
                    </div>

                    <div id="items-container">
                        <h6 class="border-bottom pb-2 mb-3" style="color: #940000 !important;">{{ __('common.pledged_items') }}</h6>
                        <div class="item-row mb-3">
                            <div class="row g-2">
                                <div class="col-md-4">
                                    <label class="small">{{ __('common.item_type') }}</label>
                                    <select class="form-select form-select-sm" name="items[0][item_type]" required>
                                ...
                                <div class="col-md-2">
                                    <label class="small">{{ __('common.qty') }}</label>
                                    <input type="number" step="0.01" class="form-control form-control-sm" name="items[0][quantity_promised]" required>
                                </div>
                                <div class="col-md-2">
                                    <label class="small">{{ __('common.unit') }}</label>
                                    <input type="text" class="form-control form-control-sm" name="items[0][unit]" placeholder="Bags, Head, etc">
                                </div>
                                <div class="col-md-3">
                                    <label class="small">{{ __('common.est_value_tzs') }}</label>
                                    <input type="number" class="form-control form-control-sm" name="items[0][estimated_value]">
                                </div>
                    ...
                    <button type="button" class="btn btn-sm mt-2" style="color: #940000 !important; border-color: #940000 !important;" onclick="addItem()">
                        <i class="fas fa-plus me-1"></i> {{ __('common.add_another_item') }}
                    </button>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">{{ __('common.cancel') }}</button>
                    <button type="submit" class="btn text-white" style="background-color: #940000 !important; border-color: #940000 !important;">{{ __('common.save_ahadi') }}</button>
                </div>
            </form>
        </div>
    </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form id="fulfillmentForm" method="POST">
                ...
                <div class="modal-body">
                    <div class="mb-3">
                        ...
                        <div class="mt-2 small text-muted">
                            {{ __('common.promised') }}: <span id="ful_promised"></span> | {{ __('common.currently_fulfilled') }}: <span id="ful_current"></span>
                        </div>
                    </div>
                    <div class="mb-3">
                        <label class="form-label fw-bold">{{ __('common.total_fulfilled_qty') }}</label>
                        <div class="input-group">
                            <input type="number" step="0.01" class="form-control" name="quantity_fulfilled" id="ful_input" required>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">{{ __('common.cancel') }}</button>
                    <button type="submit" class="btn text-white" style="background-color: #940000 !important; border-color: #940000 !important;">{{ __('common.update_progress') }}</button>
                </div>
            </form>
        </div>
    </div>
