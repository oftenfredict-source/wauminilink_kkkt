...
<div class="container-fluid px-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1 class="mt-4"><i class="fas fa-calendar-alt me-2"></i>Monthly Financial Report</h1>
    ...
    <div class="card mb-4">
        <div class="card-header bg-primary text-white">
            <i class="fas fa-filter me-1"></i><strong>Select Month</strong>
        </div>
        <div class="card-body">
            <form method="GET" action="{{ route('reports.monthly-financial') }}" class="row g-3">
                <div class="col-md-4">
                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-between">
                            <div>
                                ...
                                <div class="h5">{{ $startDate->format('M Y') }}</div>
                            </div>
                            <div class="d-flex align-items-center">
                    ...
                    <div class="card-body">
                        <table class="table table-sm">
                            ...
                            <tbody>
                                ...
                                @empty
                                <tr>
                                    <td colspan="3" class="text-center text-muted">No expenses in this month</td>
                                </tr>
                                @endforelse
                                <tr class="table-light">
