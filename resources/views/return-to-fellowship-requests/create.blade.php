...
<div class="container-fluid px-4">
            ...
            <div class="card border-0 shadow-sm">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <h1 class="h3 mb-0"><i class="fas fa-door-open me-2 text-primary"></i>Return to Church Fellowship Request</h1>
                            <p class="text-muted mb-0">Kurudi Kundini - Submit a request to return to church fellowship</p>
                        </div>
    ...
    <form action="{{ route('evangelism-leader.return-to-fellowship-requests.store') }}" method="POST" id="fellowshipRequestForm">
        @csrf
        ...
        <div class="card border-0 shadow-sm mb-4">
            ...
            <div class="card-body">
                <div class="row mb-3">
                    <div class="col-md-6">
                        <label class="form-label">Were you previously a church member? <span class="text-danger">*</span></label>
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="previously_member" id="previously_member_yes" value="1" {{ old('previously_member') == '1' ? 'checked' : '' }}>
                            <label class="form-check-label" for="previously_member_yes">Yes</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="previously_member" id="previously_member_no" value="0" {{ old('previously_member') == '0' || old('previously_member') === null ? 'checked' : '' }}>
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control" id="previous_church_branch" name="previous_church_branch" 
                               value="{{ old('previous_church_branch') }}" placeholder="If applicable">
                    </div>
                    <div class="col-md-6 mb-3">
                ...
                <div class="row">
                    <div class="col-12 mb-3">
                        ...
                        <textarea class="form-control" id="reason_for_leaving" name="reason_for_leaving" 
                                  rows="3" placeholder="Optional: Explain why you left the church...">{{ old('reason_for_leaving') }}</textarea>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="card border-0 shadow-sm mb-4">
            ...
            <div class="card-body">
                <div class="mb-3">
                    <label for="reason_for_returning" class="form-label">Reason for returning to church fellowship <span class="text-danger">*</span></label>
                    <textarea class="form-control @error('reason_for_returning') is-invalid @enderror" 
                              ...
                              placeholder="Please explain why you want to return to church fellowship..." required>{{ old('reason_for_returning') }}</textarea>
                ...
                <div class="form-check mb-3">
                    ...
                    <label class="form-check-label" for="declaration_agreed">
                        I willingly request to return to the church fellowship and commit to follow the teachings and regulations of the Church. <span class="text-danger">*</span>
                    </label>
        ...
        <div class="d-flex justify-content-end gap-2 mb-4">
            <a href="{{ route('evangelism-leader.return-to-fellowship-requests.index') }}" class="btn btn-secondary">Cancel</a>
