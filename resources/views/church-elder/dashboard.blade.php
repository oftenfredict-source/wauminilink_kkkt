            ...
            <div class="card border-0 shadow-sm">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <h1 class="h3 mb-0"><i class="fas fa-church me-2 text-primary"></i>Church Elder Dashboard</h1>
                            <p class="text-muted mb-0">{{ $community->name }} - {{ $community->campus->name ?? 'N/A' }}</p>
                        </div>
                        <div>
        ...
        <div class="col-12">
            <div class="card border-0 shadow-sm">
                ...
                <div class="card-body">
                    <div class="row g-3">
                        <div class="col-md-3">
                            <a href="{{ route('church-elder.community.show', $community->id) }}" class="btn btn-primary w-100 h-100 d-flex flex-column align-items-center justify-content-center py-3">
                                <i class="fas fa-info-circle fa-2x mb-2"></i>
                                <span>Community Info</span>
                            </a>
                        </div>
                        <div class="col-md-3">
                            <a href="{{ route('church-elder.services', $community->id) }}" class="btn btn-info w-100 h-100 d-flex flex-column align-items-center justify-content-center py-3">
                                <i class="fas fa-calendar-alt fa-2x mb-2"></i>
                                <span>Service Reports</span>
                            </a>
                        </div>
                        <div class="col-md-3">
                            <a href="{{ route('church-elder.tasks.create', $community->id) }}" class="btn btn-success w-100 h-100 d-flex flex-column align-items-center justify-content-center py-3">
                                <i class="fas fa-tasks fa-2x mb-2"></i>
                                <span>Report Task</span>
                            </a>
                        </div>
                        <div class="col-md-3">
                            <a href="{{ route('church-elder.issues.create', $community->id) }}" class="btn btn-warning w-100 h-100 d-flex flex-column align-items-center justify-content-center py-3">
                    ...
                    <div class="row g-3 mt-2">
                        <div class="col-md-4">
                            <a href="{{ route('church-elder.offerings', $community->id) }}" class="btn btn-success w-100 h-100 d-flex flex-column align-items-center justify-content-center py-3">
                                <i class="fas fa-money-bill-wave fa-2x mb-2"></i>
                                <span>Record Offerings</span>
                            </a>
                        </div>
                        <div class="col-md-4">
                            <a href="{{ route('church-elder.community-offerings.index', $community->id) }}" class="btn btn-info w-100 h-100 d-flex flex-column align-items-center justify-content-center py-3">
                ...
                <div class="card-body">
                    @if(isset($recentTasks) && $recentTasks->count() > 0)
                        <div class="list-group list-group-flush">
                            ...
                            <a href="{{ route('church-elder.tasks.show', [$community->id, $task->id]) }}" class="list-group-item list-group-item-action">
                                ...
                                <small class="text-muted">{{ $task->task_date ? \Carbon\Carbon::parse($task->task_date)->format('M d, Y') : $task->created_at->format('M d, Y') }}</small>
                            </a>
                            @endforeach
                        </div>
                        <div class="text-center mt-3">
                            <a href="{{ route('church-elder.tasks.index', $community->id) }}" class="btn btn-sm btn-outline-success">View All Tasks</a>
                        </div>
                    @else
                        <p class="text-muted text-center py-4">No tasks reported yet.</p>
                        <div class="text-center">
                            <a href="{{ route('church-elder.tasks.create', $community->id) }}" class="btn btn-sm btn-success">Create First Task</a>
                        </div>
                    @endif
                </div>
            </div>
                ...
                <div class="card-body">
                    @if(isset($recentIssues) && $recentIssues->count() > 0)
                        <div class="list-group list-group-flush">
                            ...
                            <a href="{{ route('church-elder.issues.show', [$community->id, $issue->id]) }}" class="list-group-item list-group-item-action">
                                <div class="d-flex w-100 justify-content-between">
                        ...
                        <div class="text-center mt-3">
                            <a href="{{ route('church-elder.issues.index', $community->id) }}" class="btn btn-sm btn-outline-danger">View All Issues</a>
                        </div>
                    @else
                        <p class="text-muted text-center py-4">No issues reported yet.</p>
                        <div class="text-center">
                            <a href="{{ route('church-elder.issues.create', $community->id) }}" class="btn btn-sm btn-danger">Report First Issue</a>
                        </div>
                    @endif
                </div>
            </div>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="progress" style="height: 8px;">
                            <div class="progress-bar bg-warning" role="progressbar" 
                                 style="width: {{ $stats['total_offerings'] > 0 ? ($stats['pending_offerings'] / $stats['total_offerings'] * 100) : 0 }}%"></div>
                        </div>
                    </div>
                    <div class="mb-3">
                        <div class="d-flex justify-content-between mb-2">
