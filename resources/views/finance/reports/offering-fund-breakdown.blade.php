...
<div class="container-fluid px-4">
    ...
    <div class="card border-0 shadow-sm mb-3 actions-card">
        <div class="card-header bg-white border-bottom p-2 px-3 d-flex align-items-center justify-content-between actions-header" onclick="toggleActions()">
            <div class="d-flex align-items-center gap-2">
                <h1 class="mb-0 mt-2" style="font-size: 1.5rem;"><i class="fas fa-chart-pie text-primary me-2"></i>Fund Breakdown</h1>
        </div>
            <div class="d-flex align-items-center gap-2">
    ...
    <form method="GET" action="{{ route('reports.offering-fund-breakdown') }}" class="card shadow-sm border-0 mb-4 filters-form">
        <!-- Filter Header -->
        <div class="card-header bg-gradient-primary text-white p-2 px-3 filter-header" onclick="toggleFilters()">
    ...
    <div class="row">
        <div class="col-12">
            <div class="card shadow border-0 fund-breakdown-card">
                <div class="card-header bg-primary text-white py-3 fund-breakdown-header" onclick="toggleFundBreakdown()">
                    <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center gap-2">
                        ...
                        <div class="d-flex align-items-center gap-2">
                            <span class="badge bg-white text-primary">
                                <i class="fas fa-layer-group me-1"></i>{{ count($fundBreakdown) }} {{ count($fundBreakdown) == 1 ? 'Fund Type' : 'Fund Types' }}
                            </span>
                            <i class="fas fa-chevron-down text-white d-md-none ms-2" id="fundBreakdownToggleIcon" style="transition: transform 0.3s ease;"></i>
                </div>
                    </div>
                </div>
                        ...
                        <table class="table table-hover mb-0 align-middle">
                            <thead style="background: linear-gradient(135deg, #2c3e50 0%, #34495e 100%);">
                                <tr>
                                    ...
                                    <th class="text-center pe-3 d-none d-xl-table-cell text-white" style="font-weight: 600;">
                            ...
                            <tbody>
                                ...
                                <tr class="fund-row" data-fund="{{ $fund['fund_type'] ?? $fund['offering_type'] }}">
                                        ...
                                        <div class="d-flex align-items-center">
                                            <div class="me-3 d-none d-md-block">
                                                <div class="bg-{{ $index % 2 == 0 ? 'primary' : 'success' }} rounded-circle d-flex align-items-center justify-content-center shadow-sm" 
                                                    ...
                                                    <i class="fas fa-{{ $index % 2 == 0 ? 'church' : 'coins' }} text-white fa-lg"></i>
                                                </div>
                                            </div>
                                            <div class="flex-grow-1">
                                                <h6 class="mb-1 font-weight-bold" style="color: #2c3e50;">{{ $fund['display_name'] }}</h6>
                                                <small class="d-none d-md-inline" style="color: #6c757d; font-weight: 500;">{{ ucfirst($fund['fund_type'] ?? $fund['offering_type']) }}</small>
                                                <div class="d-md-none mt-3">
                                                    <div class="d-flex flex-column gap-2">
                                                        <div class="d-flex justify-content-between align-items-center p-2 rounded border-start border-3" style="background-color: #e3f2fd !important; border-left-color: #2196f3 !important;">
                                                            <span class="small fw-semibold" style="color: #1565c0 !important;"><i class="fas fa-gift me-1" style="color: #1976d2 !important;"></i>From Offerings</span>
                                                            <span class="fw-bold" style="color: #0d47a1 !important; font-size: 0.95rem; min-width: 80px; text-align: right; display: block !important; visibility: visible !important; opacity: 1 !important;">TZS {{ number_format(isset($fund['offering_amount']) ? $fund['offering_amount'] : 0, 0) }}</span>
                                                        </div>
                                                        <div class="d-flex justify-content-between align-items-center p-2 rounded border-start border-3" style="background-color: #e0f7fa !important; border-left-color: #00bcd4 !important;">
                                                            <span class="small fw-semibold" style="color: #00838f !important;"><i class="fas fa-heart me-1" style="color: #00acc1 !important;"></i>From Donations</span>
                                                            <span class="fw-bold" style="color: #006064 !important; font-size: 0.95rem; min-width: 80px; text-align: right; display: block !important; visibility: visible !important; opacity: 1 !important;">TZS {{ number_format(isset($fund['donation_amount']) ? $fund['donation_amount'] : 0, 0) }}</span>
                                                        </div>
                                                        <div class="d-flex justify-content-between align-items-center p-2 bg-{{ $fund['utilization_percentage'] > 80 ? 'danger' : ($fund['utilization_percentage'] > 50 ? 'warning' : 'success') }} bg-opacity-10 rounded border-start border-{{ $fund['utilization_percentage'] > 80 ? 'danger' : ($fund['utilization_percentage'] > 50 ? 'warning' : 'success') }} border-3">
                                                            <span class="small fw-semibold" style="color: #495057;"><i class="fas fa-percentage me-1" style="color: {{ $fund['utilization_percentage'] > 80 ? '#dc3545' : ($fund['utilization_percentage'] > 50 ? '#ffc107' : '#28a745') }};"></i>Utilization</span>
                                                            <span class="badge bg-{{ $fund['utilization_percentage'] > 80 ? 'danger' : ($fund['utilization_percentage'] > 50 ? 'warning' : 'success') }} text-white">
                                                                {{ $fund['utilization_percentage'] }}%
                                                            </span>
                                                        </div>
                                                        <div class="d-flex gap-2 mt-1">
                                                            @if($fund['status'] == 'available')
                                                                <span class="badge bg-success text-white flex-fill text-center py-2">
                                                                    <i class="fas fa-check-circle me-1"></i>Available
                                                                </span>
                                                            @else
                                                                <span class="badge bg-danger text-white flex-fill text-center py-2">
                                    ...
                                    <td class="align-middle text-end">
                                        <div class="d-flex flex-column align-items-end">
                                            ...
                                            <small class="fw-semibold d-none d-lg-inline" style="color: #6c757d;">Total Income</small>
                                        </div>
                                    </td>
                                    <td class="align-middle text-end d-none d-lg-table-cell">
                                        @if(isset($fund['offering_amount']) && $fund['offering_amount'] > 0)
                                            <div class="d-flex flex-column align-items-end">
                                                <span class="font-weight-bold" style="color: #4e73df;">
                                    ...
                                    <td class="align-middle text-end">
                                        <div class="d-flex flex-column align-items-end">
                                            ...
                                            <small class="fw-semibold d-none d-lg-inline" style="color: #6c757d;">Amount Used</small>
                                            @if(!empty($fund['expense_details']) && count($fund['expense_details']) > 0)
                                                <button type="button" class="btn btn-sm btn-outline-info mt-2 d-none d-lg-inline-block" 
                                                        onclick="toggleExpenseDetails('{{ $fund['offering_type'] }}')"
                                                        title="View expense breakdown">
                                    ...
                                    <td class="align-middle text-end">
                                        <div class="d-flex flex-column align-items-end">
                                            <span class="h6 mb-0 font-weight-bold" style="color: {{ $fund['available_amount'] > 0 ? '#4e73df' : '#dc3545' }};">
                                                TZS {{ number_format($fund['available_amount'], 0) }}
                                            </span>
                                            <small class="d-none d-lg-inline" style="color: #6c757d; font-weight: 500;">Remaining</small>
                                        </div>
                                    </td>
                                    ...
                                    <td class="align-middle pe-3 d-none d-xl-table-cell">
                                        <div class="progress-container position-relative">
                                            <div class="progress" style="height: 32px; border-radius: 16px; background-color: #e9ecef;">
                                            ...
                                            <div class="progress-text-overlay position-absolute top-50 start-50 translate-middle text-center">
                                                <span class="badge bg-dark text-white fw-bold" style="font-size: 0.75rem; padding: 0.25rem 0.5rem; border: 2px solid rgba(255,255,255,0.9); background-color: #212529 !important;">
                                                    {{ $fund['utilization_percentage'] }}%
                                                </span>
                                            </div>
                                        </div>
                                ...
                                <tr id="expense-details-{{ $fund['offering_type'] }}" class="expense-details-row" style="display: none;">
                                    <td colspan="9" class="bg-light">
                                        <div class="p-3">
                                            <h6 class="mb-3 fw-bold" style="color: #4e73df;">
                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-sm table-bordered table-hover mb-0">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <strong style="color: #2c3e50;">{{ $expense['expense_name'] }}</strong>
                                                            </td>
                                                            <td>
                                                                <span class="badge bg-info">{{ $expense['category'] }}</span>
                                                            </td>
                                                            <td style="color: #495057;">{{ $expense['budget_name'] }}</td>
                                                            <td style="color: #6c757d;">{{ \Carbon\Carbon::parse($expense['expense_date'])->format('M d, Y') }}</td>
                                                            <td class="text-end">
                                                                <strong style="color: #2c3e50;">TZS {{ number_format($expense['total_amount'], 0) }}</strong>
                                                            </td>
                                                            <td class="text-end">
                                                                <strong style="color: #e0a800;">TZS {{ number_format($expense['offering_amount'], 0) }}</strong>
                                                            </td>
                                                        </tr>
                                                        @endforeach
                                ...
                                <tr>
                                    <td colspan="9" class="text-center py-5">
                                        <div class="d-flex flex-column align-items-center">
                                            ...
                                            <p style="color: #6c757d;">No offering data found for the selected period.</p>
                                        </div>
                                    </td>
                                </tr>
                                @endforelse
                            ...
                            <tfoot class="table-light">
                                <tr class="fw-bold">
                                    <td class="ps-3">
                                        <i class="fas fa-calculator me-2" style="color: #4e73df;"></i><strong style="color: #2c3e50;">Grand Total</strong>
                                    </td>
                                    <td class="text-end">
                                    ...
                                    <td class="text-end d-none d-lg-table-cell">
                                        <span class="fw-bold" style="color: #4e73df;">
                                            TZS {{ number_format(collect($fundBreakdown)->sum(function($f) { return $f['offering_amount'] ?? 0; }), 0) }}
                                        </span>
                                    </td>
                                    <td class="text-end d-none d-lg-table-cell">
                                        <span class="fw-bold" style="color: #36b9cc;">
                                            TZS {{ number_format(collect($fundBreakdown)->sum(function($f) { return $f['donation_amount'] ?? 0; }), 0) }}
                                        </span>
                                    </td>
                                    <td class="text-end">
                                    ...
                                    <td class="text-end">
                                        <span class="h6 mb-0 fw-bold" style="color: #4e73df;">
...
@media (max-width: 576px) {
    ...
    .table td:nth-child(9) {
        display: none; /* Hide Utilization and Progress columns on very small screens */
    }
