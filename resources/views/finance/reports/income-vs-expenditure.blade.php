...
<style>
    ...
    @media (max-width: 768px) {
        ...
        .col-xl-3, .col-md-6, .col-xl-6, .col-md-4 {
            margin-bottom: 1rem;
        }
        ...
        /* Chart Container */
        #monthlyTrendChart, #incomeChart, #expenseChart {
...
<div class="container-fluid px-4">
    ...
    <div class="card border-0 shadow-sm mb-3 actions-card">
        <div class="card-header bg-white border-bottom p-2 px-3 d-flex align-items-center justify-content-between actions-header" onclick="toggleActions()">
            <div class="d-flex align-items-center gap-2">
                <h1 class="mb-0 mt-2" style="font-size: 1.5rem;"><i class="fas fa-chart-line me-2"></i>Income vs Expenditure</h1>
            </div>
            <div class="d-flex align-items-center gap-2">
    ...
    <form method="GET" action="{{ route('reports.income-vs-expenditure') }}" id="reportForm" class="card mb-4 border-0 shadow-sm filters-form">
        <!-- Filter Header -->
            ...
            <div class="d-flex align-items-center justify-content-between">
                <div class="d-flex align-items-center gap-2">
                    ...
                    @if(request('filter_type') || request('start_date') || request('end_date') || request('month'))
                        <span class="badge bg-white text-primary rounded-pill ms-2" id="activeFiltersCount">{{ (request('filter_type') ? 1 : 0) + (request('start_date') ? 1 : 0) + (request('end_date') ? 1 : 0) + (request('month') ? 1 : 0) }}</span>
                    @endif
                </div>
        ...
        <div class="card-body p-3" id="filterBody">
            <div class="row g-2 mb-2">
                ...
                <div class="col-12 col-md-3">
                    ...
                    <select class="form-select form-select-sm" id="filter_type" name="filter_type" onchange="toggleFilterType()">
                ...
                <div class="col-12 col-md-3" id="month_filter" style="display: {{ request('filter_type') == 'month' ? 'block' : 'none' }};">
                ...
                <div class="col-6 col-md-3" id="start_date_filter" style="display: {{ !request('filter_type') || request('filter_type') == 'date_range' ? 'block' : 'none' }};">
                ...
                <div class="col-6 col-md-3" id="end_date_filter" style="display: {{ !request('filter_type') || request('filter_type') == 'date_range' ? 'block' : 'none' }};">
