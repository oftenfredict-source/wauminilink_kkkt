                ...
                <div class="card border-0 shadow-sm">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <a href="{{ route('evangelism-leader.church-wedding-requests.create') }}"
                            ...
                            <tbody>
                                @foreach($requests as $request)
                                    <tr>
                                        ...
                                        <td>{{ $request->preferred_wedding_date ? $request->preferred_wedding_date->format('M d, Y') : 'Not Set' }}
                                        </td>
                                        <td>
                ...
                @else
                    <div class="text-center py-5">
                        ...
                        <p class="text-muted">No requests found. <a
                                href="{{ route('evangelism-leader.church-wedding-requests.create') }}">Create a new request</a>
                        </p>
                    </div>
                @endif
            </div>
