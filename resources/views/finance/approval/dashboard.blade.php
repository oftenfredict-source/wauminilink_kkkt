                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="card border-0 shadow-sm h-100" style="background: linear-gradient(135deg, #ffc107 0%, #ff8c00 100%);">
                                <div class="card-body text-center text-white p-4">
                                    <div class="bg-white bg-opacity-20 rounded-circle d-inline-flex align-items-center justify-content-center mb-3 shadow-sm" style="width: 60px; height: 60px;">
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="card border-0 shadow-sm h-100" style="background: linear-gradient(135deg, #6f42c1 0%, #e83e8c 100%);">
                                <div class="card-body text-center text-white p-4">
                                    ...
                                    <h3 class="fw-bold mb-1" style="font-size: 1.2rem;">{{ $approverName ?? $currentUser->name ?? auth()->user()->name }}</h3>
                            ...
                            <div class="card border-0 bg-light">
                                <div class="card-body p-4">
                                    ...
                                    <div class="d-flex flex-wrap gap-3">
                                        @if($canApprove)
                                            <button type="button" class="btn btn-success px-4 py-2 rounded-pill shadow-sm fw-bold" onclick="bulkApprove()">
                                                <i class="fas fa-check-double me-2"></i> 
                                                Bulk Approve
                                            </button>
                                        @endif
                                        <button type="button" class="btn btn-primary px-4 py-2 rounded-pill shadow-sm fw-bold" onclick="refreshData()">
                                            <i class="fas fa-sync me-2"></i> 
                                            Refresh
                                        </button>
                                        <button type="button" class="btn btn-info px-4 py-2 rounded-pill shadow-sm fw-bold" onclick="exportPending()">
                                            <i class="fas fa-download me-2"></i> 
                                            Export
                                        </button>
                                        <a href="{{ route('finance.approval.funding-requests') }}" class="btn btn-warning px-4 py-2 rounded-pill shadow-sm fw-bold text-white">
                        ...
                        <div class="col-12">
                            <div class="card border-0 shadow-sm">
                                <div class="card-header bg-white border-0 p-0">
                                    ...
                                    <ul class="nav nav-pills nav-fill bg-white px-4 pt-3 pb-2" id="pendingTabs" role="tablist">
                                        <li class="nav-item" role="presentation">
                                            <button class="nav-link active rounded-pill me-2 mb-3 px-3 py-2" id="tithes-tab" data-bs-toggle="tab" data-bs-target="#tithes" type="button" role="tab">
                                                <i class="fas fa-coins me-2"></i>
                                                <span class="fw-bold">Tithes</span>
                                                <span class="badge bg-warning text-dark ms-2 px-2 py-1">{{ $pendingTithes->count() }}</span>
                                            </button>
                                        </li>
                                        <li class="nav-item" role="presentation">
                                            <button class="nav-link rounded-pill me-2 mb-3 px-3 py-2" id="offerings-tab" data-bs-toggle="tab" data-bs-target="#offerings" type="button" role="tab">
                                                <i class="fas fa-gift me-2"></i>
                                                <span class="fw-bold">Offerings</span>
                                                <span class="badge bg-warning text-dark ms-2 px-2 py-1">{{ $pendingOfferings->count() }}</span>
                                            </button>
                                        </li>
                                        <li class="nav-item" role="presentation">
                                            <button class="nav-link rounded-pill me-2 mb-3 px-3 py-2" id="donations-tab" data-bs-toggle="tab" data-bs-target="#donations" type="button" role="tab">
                                                <i class="fas fa-heart me-2"></i>
                                                <span class="fw-bold">Donations</span>
                                                <span class="badge bg-warning text-dark ms-2 px-2 py-1">{{ $pendingDonations->count() }}</span>
                                            </button>
                                        </li>
                                        <li class="nav-item" role="presentation">
                                            <button class="nav-link rounded-pill me-2 mb-3 px-3 py-2" id="expenses-tab" data-bs-toggle="tab" data-bs-target="#expenses" type="button" role="tab">
                                                <i class="fas fa-receipt me-2"></i>
                                                <span class="fw-bold">Expenses</span>
                                                <span class="badge bg-warning text-dark ms-2 px-2 py-1">{{ $pendingExpenses->count() }}</span>
                                            </button>
                                        </li>
                                        <li class="nav-item" role="presentation">
                                            <button class="nav-link rounded-pill me-2 mb-3 px-3 py-2" id="budgets-tab" data-bs-toggle="tab" data-bs-target="#budgets" type="button" role="tab">
                                                <i class="fas fa-wallet me-2"></i>
                                                <span class="fw-bold">Budgets</span>
                                                <span class="badge bg-warning text-dark ms-2 px-2 py-1">{{ $pendingBudgets->count() }}</span>
                                            </button>
                                        </li>
                                        <li class="nav-item" role="presentation">
                                            <button class="nav-link rounded-pill me-2 mb-3 px-3 py-2" id="pledge-payments-tab" data-bs-toggle="tab" data-bs-target="#pledge-payments" type="button" role="tab">
