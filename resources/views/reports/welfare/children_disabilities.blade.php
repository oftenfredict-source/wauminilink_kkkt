...
<div class="container-fluid px-4">
    <h1 class="mt-4">Children with Disabilities Report</h1>
    <ol class="breadcrumb mb-4">
        <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Dashboard</a></li>
        <li class="breadcrumb-item"><a href="{{ route('reports.welfare.index') }}">Social Welfare</a></li>
        <li class="breadcrumb-item active">Children with Disabilities</li>
    </ol>
    ...
    <div class="card mb-4">
        ...
        <div class="card-body">
            <form method="GET" action="{{ route('reports.welfare.children.disabilities') }}">
                <div class="row g-3">
                    <div class="col-md-3">
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="text" class="form-control" name="disability_type" value="{{ request('disability_type') }}" placeholder="e.g. Visual Impairment">
                    </div>
                    <div class="col-md-3">
                    ...
                    <div class="col-12 text-end">
                        <a href="{{ route('reports.welfare.children.disabilities') }}" class="btn btn-secondary me-2">Reset</a>
                        <button type="submit" class="btn btn-primary"><i class="fas fa-search me-1"></i> Filter</button>
                        <a href="{{ route('reports.welfare.children.disabilities.export', request()->all()) }}" class="btn btn-success ms-2"><i class="fas fa-file-excel me-1"></i> Export Excel</a>
                    </div>
                </div>
            </form>
        </div>
                    ...
                    <tbody>
                        @forelse($children as $child)
                            <tr>
                                ...
                                <td>
                                    <span class="badge bg-warning text-dark">{{ $child->disability_type ?? 'Disabled' }}</span>
                                </td>
