            ...
            <div class="card border-0 shadow-sm">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <h1 class="h3 mb-0"><i class="fas fa-heart me-2 text-primary"></i>Marriage Blessing Requests</h1>
                            <p class="text-muted mb-0">Baraka ya Ndoa - Manage marriage blessing requests</p>
                        </div>
                        <a href="{{ route('evangelism-leader.marriage-blessing-requests.create') }}" class="btn btn-primary">
        ...
        <div class="card-body">
            ...
            @else
                <div class="text-center py-5">
                    ...
                    <p class="text-muted">No requests found. <a href="{{ route('evangelism-leader.marriage-blessing-requests.create') }}">Create a new request</a></p>
                </div>
            @endif
        </div>
    </div>
