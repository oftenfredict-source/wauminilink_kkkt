                ...
                <div class="row g-2 mb-2">
                    ...
                    <div class="col-6 col-md-3">
                        ...
                        <select class="form-select form-select-sm" id="budget_type" name="budget_type">
                            ...
                            <option value="injili" {{ request('budget_type') == 'injili' ? 'selected' : '' }}>Injili</option>
                            <option value="umoja" {{ request('budget_type') == 'umoja' ? 'selected' : '' }}>Umoja na Idara
                            </option>
                            <option value="majengo" {{ request('budget_type') == 'majengo' ? 'selected' : '' }}>Majengo
                            </option>
                            <option value="other" {{ request('budget_type') == 'other' ? 'selected' : '' }}>Zinginezo</option>
                        </select>
                    </div>
        ...
        <div class="row g-3 mb-4">
            ...
            <div class="col-6 col-md-3">
                <div class="card border-0 shadow-sm bg-success text-white h-100">
                    <div class="card-body p-3">
                        <div class="d-flex justify-content-between align-items-center mb-2">
                            <small class="text-white-50 fw-bold text-uppercase">B. UMOJA NA IDARA</small>
                ...
                <ul class="nav nav-tabs border-0" id="budgetTabs" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                        <button class="nav-link fw-bold text-uppercase py-3 px-4 text-success" id="umoja-tab"
                            data-bs-toggle="tab" data-bs-target="#umoja" type="button" role="tab">B. UMOJA NA IDARA</button>
                    </li>
                    <li class="nav-item" role="presentation">
            ...
            <div class="card-body p-0">
                <div class="tab-content" id="budgetTabsContent">
                    ...
                    <div class="tab-pane fade" id="umoja" role="tabpanel">
                        @include('finance.partials.budget_table', ['budgets' => $umojaBudgets, 'category' => 'Umoja na Idara'])
                    </div>
                    {{-- Majengo Tab --}}
    ...
    <script>     // Toggle Actions Function
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            document.addEventListener('change', function (e) {
                // Handle Add Budget Modal - Budget Type (Category)
