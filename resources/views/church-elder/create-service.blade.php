                    ...
                    <div class="card-body">
                        <form id="serviceForm">
                            ...
                            <div class="row g-2 mb-2">
                                <div class="col-md-3">
                                    <label for="service_date" class="form-label small">Service Date <span
                                            class="text-danger">*</span></label>
                                    <input type="date" name="service_date" id="service_date"
                                        class="form-control form-control-sm" value="{{ date('Y-m-d') }}" required>
                                </div>
                                <div class="col-md-3">
                                    <label for="service_type" class="form-label small">Service Type <span
                                            class="text-danger">*</span></label>
                            ...
                            <div class="row g-2 mb-2">
                                <div class="col-md-4">
                                    ...
                                    <input type="text" name="theme" id="theme" class="form-control form-control-sm"
                                        maxlength="255">
                                </div>
                                <div class="col-md-4">
                                    <label for="preacher" class="form-label small">Preacher</label>
                                    <input type="text" name="preacher" id="preacher" class="form-control form-control-sm"
                                        maxlength="255">
                                </div>
                                <div class="col-md-4">
                            ...
                            <div class="row g-2 mb-2">
                                ...
                                <div class="col-md-2">
                                    <label for="attendance_count" class="form-label small">Attendance Count</label>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="number" name="offerings_amount" id="offerings_amount"
                            ...
                            <div class="row g-2 mb-2">
                                <div class="col-md-6">
                                    ...
                                    <textarea name="scripture_readings" id="scripture_readings"
                                        class="form-control form-control-sm" rows="2"></textarea>
                                </div>
                                <div class="col-md-6">
                                    <label for="announcements" class="form-label small">Announcements</label>
                                    <textarea name="announcements" id="announcements" class="form-control form-control-sm"
                                        rows="2"></textarea>
                                </div>
                            </div>
