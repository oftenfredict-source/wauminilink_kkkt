                    ...
                    <div class="card h-100 shadow-sm hover-shadow transition-all border-0 rounded-4">
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-start mb-3">
                                ...
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-end">
                                        <li><a class="dropdown-item" href="{{ route('departments.show', $dept->id) }}"><i
                                                    class="fas fa-eye me-2 text-primary"></i>View Details</a></li>
                                        @unless(auth()->user()->isSecretary())
                                            <li>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="d-flex flex-wrap gap-1">
                                    ...
                                    @if(isset($dept->criteria['gender']))
                                        <span
                                            class="badge bg-{{ $dept->criteria['gender'] === 'male' ? 'info' : 'danger' }} text-white">
                            ...
                            <div class="d-flex justify-content-between align-items-center mt-auto pt-3 border-top">
                                <span class="text-muted small"><i class="fas fa-users me-1"></i> {{ $dept->members_count }}
                                    Members</span>
                                <a href="{{ route('departments.show', $dept->id) }}"
                                    class="btn btn-outline-primary btn-sm rounded-pill px-3">Manage</a>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="row g-3">
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    <input type="number" name="criteria[min_age]" class="form-control" placeholder="Min"
                                        min="0">
                                    <span class="input-group-text">-</span>
                                    <input type="number" name="criteria[max_age]" class="form-control" placeholder="Max"
                                        min="0">
                                </div>
                            </div>
                            <div class="col-md-6">
