...
@section('content')
    <div class="container-fluid px-4">
                    ...
                    <div class="card-body py-2 px-3">
                        <div class="d-flex align-items-center justify-content-between flex-wrap gap-3">
                            <div class="d-flex align-items-center gap-3">
                                <div class="dashboard-profile-img">
                                    @if($member->profile_picture)
                                        <img src="{{ asset('storage/' . $member->profile_picture) }}" alt="Profile Picture"
                            ...
                            <div class="d-flex align-items-center gap-3 header-widgets">
                                <div
                                    class="widget d-flex align-items-center gap-2 px-3 py-2 rounded-3 bg-danger text-white">
        ...
        <div class="row mb-3">
            <div class="col-12">
                <div class="card border-0 shadow-sm payment-info-banner"
                    style="background: linear-gradient(135deg, #940000 0%, #b30000 100%); overflow: hidden;">
                    <div class="card-body py-3 px-0" style="position: relative;">
                        <div class="marquee-wrapper" style="overflow: hidden; white-space: nowrap;">
                            <div class="marquee-content"
                                style="display: inline-block; animation: scroll-left 50s linear infinite; color: white; font-weight: 600; font-size: 1.05rem; padding: 0.75rem 0;">
                                <span class="marquee-item">
                                    <i class="fas fa-church me-2"></i>
                                    <strong>Karibu katika kanisa la KKKT USHIRIKA WA LONGUO</strong> |
                                    <i class="fas fa-heart me-1"></i> Karibu tuabudu pamoja — <strong>Mungu
                                        akubariki!</strong>
                                </span>
            ...
            <div class="col-12">
                <div class="card border-0 shadow-sm">
                    <div class="card-header bg-gradient-danger text-white"
                        style="background: linear-gradient(135deg, #940000 0%, #b30000 100%);">
                        <div class="d-flex justify-content-between align-items-center">
                            <h5 class="mb-0 text-white" style="color: white !important;"><i
                                    class="fas fa-users-cog me-2 text-white" style="color: white !important;"></i>Church
                                Leadership</h5>
                    ...
                    <div class="card-body">
                        ...
                        @if(isset($leadershipData['unread_notifications']) && $leadershipData['unread_notifications']->count() > 0)
                            <div class="alert alert-success alert-dismissible fade show" role="alert">
                                ...
                                @foreach($leadershipData['unread_notifications'] as $notification)
                                    ...
                                    @endphp
                                    <div class="mb-2">
                                        <strong>Congratulations!</strong> You have been appointed as
                                        <strong>{{ $data['position_display'] ?? 'Leader' }}</strong>
                        ...
                        @if(isset($leadershipData['member_positions']) && $leadershipData['member_positions']->count() > 0)
                            <div class="mb-4">
                                <h6 class="text-danger mb-3"><i class="fas fa-user-tie me-2"></i>Your Leadership Positions</h6>
                                <div class="row">
                                                ...
                                                <div class="card-body">
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div class="flex-grow-1">
                                                            <h6 class="mb-1 text-danger">{{ $position->position_display }}</h6>
                    ...
                    <div class="card border-0 shadow-sm">
                        ...
                        <div class="card-body">
                            @foreach($announcements['announcements']->take(3) as $announcement)
                                ...
                                @endphp
                                <div
                                    class="card mb-2 border-0 shadow-sm {{ $announcement->is_pinned ? 'border-warning border-2' : '' }} {{ $isUnread ? 'border-danger border-2' : '' }}">
                                    <div class="card-body p-3">
                                        <div class="d-flex justify-content-between align-items-start">
                                            <div class="flex-grow-1">
                                                ...
                                                <small class="text-muted">
                                                    <span
                                                        class="badge bg-{{ $announcement->type === 'urgent' ? 'danger' : ($announcement->type === 'event' ? 'success' : ($announcement->type === 'reminder' ? 'warning' : 'secondary')) }} me-2">
                            ...
                            <div class="text-center mt-2">
                                <a href="{{ route('member.announcements') }}" class="btn btn-sm btn-outline-secondary">
    ...
    <style>
        ...
        .bg-gradient-danger {
            background: linear-gradient(135deg, #940000 0%, #b30000 100%) !important;
        }

        /* Payment info banner styling */
        .payment-info-banner {
            border-radius: 12px !important;
            box-shadow: 0 4px 15px rgba(148, 0, 0, 0.3) !important;
        }
