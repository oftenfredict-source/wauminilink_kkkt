            ...
            <div class="card border-0 shadow-sm">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <h1 class="h3 mb-0"><i class="fas fa-door-open me-2 text-warning"></i>Pending Return to Fellowship Requests</h1>
                            <p class="text-muted mb-0">Review and approve return to fellowship requests</p>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <table class="table table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-end">
                                    <a href="{{ route('pastor.return-to-fellowship-requests.show', $request->id) }}" 
