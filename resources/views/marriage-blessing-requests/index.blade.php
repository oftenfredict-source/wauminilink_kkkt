                ...
                <div class="card border-0 shadow-sm">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                <h1 class="h3 mb-0"><i class="fas fa-heart me-2 text-primary"></i>Marriage Blessing Requests
                                </h1>
                                <p class="text-muted mb-0">Baraka ya Ndoa - Manage marriage blessing requests</p>
                            </div>
                            <a href="{{ route('evangelism-leader.marriage-blessing-requests.create') }}"
            ...
            <div class="card-body">
                            ...
                            <tbody>
                                @foreach($requests as $request)
                                    <tr>
                                        ...
                                        <td>{{ $request->marriage_date ? $request->marriage_date->format('M d, Y') : 'Not Set' }}
                                        </td>
                                        <td>
                                        ...
                                        <td class="text-end">
                                            <a href="{{ route('evangelism-leader.marriage-blessing-requests.show', $request->id) }}"
                ...
                @else
                    <div class="text-center py-5">
                        ...
                        <p class="text-muted">No requests found. <a
                                href="{{ route('evangelism-leader.marriage-blessing-requests.create') }}">Create a new
                                request</a></p>
                    </div>
                @endif
            </div>
