                        ...
                        <form action="{{ route('leaders.store') }}" method="POST">
                            ...
                            @elseif($userCampus && $userCampus->is_main_campus)
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" id="campus_id" name="campus_id">
                                        <option value="">{{ autoTranslate('Mtaa wa Senta (Main Campus)') }}</option>
                                    ...
                                    <small
                                        class="form-text text-muted">{{ autoTranslate('Select branch for this leader, or leave blank for Mtaa wa Senta') }}</small>
                                </div>
                            @endif

                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    <label for="member_id" class="form-label">{{ autoTranslate('Select Member') }} <span
                                ...
                                <div class="col-md-6 mb-3">
                                    <label for="position" class="form-label">{{ autoTranslate('Position') }} <span
                                            class="text-danger">*</span></label>
                            ...
                            <div class="mb-3" id="position_title_field" style="display: none;">
                                <label for="position_title"
                                    class="form-label">{{ autoTranslate('Custom Position Title') }}</label>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    <label for="appointment_date" class="form-label">{{ autoTranslate('Appointment Date') }}
                                ...
                                <div class="col-md-6 mb-3">
                                    <label for="end_date"
                                        class="form-label">{{ autoTranslate('End Date (Optional)') }}</label>
                            ...
                            <div class="d-flex justify-content-end gap-2">
                                <a href="{{ route('leaders.index') }}"
                                    class="btn btn-secondary">{{ autoTranslate('Cancel') }}</a>
                ...
                <div class="card mt-3">
                    ...
                    <div class="card-body">
                        <div class="small text-muted">
                            ...
                            {{ autoTranslate('total members available for leadership positions.') }}
                        </div>
                    </div>
                </div>
            </div>
