...
<div class="container-fluid px-4">
            ...
            <div class="card border-0 shadow-sm">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <h1 class="h3 mb-0"><i class="fas fa-water me-2 text-primary"></i>Baptism Application Form</h1>
    ...
    <form action="{{ route('evangelism-leader.baptism-applications.store') }}" method="POST" enctype="multipart/form-data" id="baptismApplicationForm">
        @csrf
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 mb-3" id="phone_number_field">
                        ...
                        @error('phone_number')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                        <small class="text-muted" id="phone_help_text">Applicant's phone number</small>
                    </div>
                    <div class="col-md-3 mb-3" id="email_field">
                        ...
                        @error('email')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                        <small class="text-muted" id="email_help_text">Applicant's email (optional)</small>
                    </div>
        ...
        <div class="card border-0 shadow-sm mb-4">
            ...
            <div class="card-body">
                <div class="row mb-3">
                    <div class="col-md-6">
                        <label class="form-label">Have you ever been baptized before? <span class="text-danger">*</span></label>
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="previously_baptized" id="previously_baptized_yes" value="1" {{ old('previously_baptized') == '1' || old('previously_baptized') === '1' ? 'checked' : '' }}>
                            <label class="form-check-label" for="previously_baptized_yes">Yes</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="previously_baptized" id="previously_baptized_no" value="0" {{ old('previously_baptized') == '0' || old('previously_baptized') === null || old('previously_baptized') === '' ? 'checked' : '' }}>
                    ...
                    <div class="col-md-6" id="previous_baptism_fields" style="display: none;">
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" id="previous_church_name" name="previous_church_name" value="{{ old('previous_church_name') }}">
                            </div>
                            <div class="col-md-6 mb-3">
                                <label for="previous_baptism_date" class="form-label">Date of Baptism</label>
                                <input type="date" class="form-control" id="previous_baptism_date" name="previous_baptism_date" 
                                       value="{{ old('previous_baptism_date') }}" max="{{ date('Y-m-d') }}">
                            </div>
                        </div>
                    </div>
                </div>
                <div class="row mb-3">
                    <div class="col-md-6">
                        <label class="form-label">Have you attended baptism classes? <span class="text-danger">*</span></label>
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="attended_baptism_classes" id="attended_classes_yes" value="1" {{ old('attended_baptism_classes') == '1' || old('attended_baptism_classes') === '1' ? 'checked' : '' }}>
                            <label class="form-check-label" for="attended_classes_yes">Yes</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="attended_baptism_classes" id="attended_classes_no" value="0" {{ old('attended_baptism_classes') == '0' || old('attended_baptism_classes') === null || old('attended_baptism_classes') === '' ? 'checked' : '' }}>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control" id="church_attendance_duration" name="church_attendance_duration" 
                               value="{{ old('church_attendance_duration') }}" placeholder="e.g., 1 year, 2 years">
                        <small class="text-muted">How long have you been attending church?</small>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6 mb-3">
                        <label for="pastor_catechist_name" class="form-label">Name of Pastor / Catechist who knows you</label>
        ...
        <div class="card border-0 shadow-sm mb-4">
            ...
            <div class="card-body">
                <div class="alert alert-info mb-3" id="childApplicantAlert" style="display: none;">
                    ...
                    <strong>Child Applicant:</strong> Since the applicant is under 18 years old, parent/guardian information is required.
                </div>
                <div class="row">
                    <div class="col-md-6 mb-3">
                        <label for="parent_guardian_name" class="form-label">
                            Parent / Guardian Name 
                            <span class="text-danger" id="parent_required_indicator" style="display: none;">*</span>
                        </label>
                        <input type="text" class="form-control @error('parent_guardian_name') is-invalid @enderror" 
                               id="parent_guardian_name" name="parent_guardian_name" 
                               value="{{ old('parent_guardian_name') }}">
                        @error('parent_guardian_name')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                        <small class="text-muted">Required if applicant is under 18 years old</small>
                    </div>
                    <div class="col-md-6 mb-3" id="guardian_contact_fields" style="display: none;">
                        <div class="row">
                            <div class="col-md-6 mb-2">
                                ...
                                <input type="text" class="form-control @error('guardian_phone') is-invalid @enderror" 
                                       ...
                                       value="{{ old('guardian_phone') }}" placeholder="Optional">
                            ...
                            <div class="col-md-6 mb-2">
                                ...
                                <input type="email" class="form-control @error('guardian_email') is-invalid @enderror" 
                                       ...
                                       value="{{ old('guardian_email') }}" placeholder="Optional">
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <textarea class="form-control" id="family_religious_background" name="family_religious_background" 
                                  rows="2" placeholder="Optional: Describe the family's religious background...">{{ old('family_religious_background') }}</textarea>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="card border-0 shadow-sm mb-4">
            ...
            <div class="card-body">
                <div class="mb-3">
                    <label for="reason_for_baptism" class="form-label">Reason for requesting baptism <span class="text-danger">*</span></label>
                    <textarea class="form-control @error('reason_for_baptism') is-invalid @enderror" 
                              ...
                              placeholder="Please explain why you (or your child) want to be baptized..." required>{{ old('reason_for_baptism') }}</textarea>
                    @error('reason_for_baptism')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                    <small class="text-muted">Minimum 20 characters required. For child applicants, parent/guardian may write on behalf of the child.</small>
                </div>
                <div class="form-check mb-3">
                    ...
                    <label class="form-check-label" for="declaration_agreed">
                        <span id="declaration_text">
                            I declare that I am applying for baptism voluntarily and according to the teachings of the Church.
                        </span>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const parentGuardianInput = document.getElementById('parent_guardian_name');
    const parentRequiredIndicator = document.getElementById('parent_required_indicator');
    ...
    function calculateAge() {
        if (dateOfBirthInput.value) {
            ...
            if (age < 18 && age > 0) {
                ...
                // Make parent/guardian required
                parentGuardianInput.required = true;
                parentRequiredIndicator.style.display = 'inline';
                parentGuardianInput.classList.add('border-warning');
                
                // Make phone and email optional for child
                phoneNumberInput.required = false;
                phoneRequiredIndicator.style.display = 'none';
                phoneHelpText.textContent = "Child's phone number (optional)";
                
                emailHelpText.textContent = "Child's email (optional)";
                
                // Hide marital status for children
                maritalStatusField.style.display = 'none';
                
                // Show guardian contact fields
                guardianContactFields.style.display = 'block';
                ...
                // Make parent/guardian optional for adults
                parentGuardianInput.required = false;
                parentRequiredIndicator.style.display = 'none';
                parentGuardianInput.classList.remove('border-warning');
                
                // Make phone required for adults
                phoneNumberInput.required = true;
                phoneRequiredIndicator.style.display = 'inline';
                phoneHelpText.textContent = "Applicant's phone number";
                
                emailHelpText.textContent = "Applicant's email (optional)";
                
                // Show marital status for adults
                maritalStatusField.style.display = 'block';
                
                // Hide guardian contact fields
                guardianContactFields.style.display = 'none';
