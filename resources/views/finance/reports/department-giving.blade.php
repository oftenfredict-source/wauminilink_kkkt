...
@section('content')
    ...
    <div class="container-fluid px-4">
        ...
        <div class="card border-0 shadow-sm mb-3 actions-card">
            <div class="card-header bg-white border-bottom p-2 px-3 d-flex align-items-center justify-content-between actions-header"
                ...
                <div class="d-flex align-items-center gap-2">
                    <h1 class="mb-0 mt-2" style="font-size: 1.5rem;"><i class="fas fa-building me-2"></i>Department Giving
                        Report</h1>
                </div>
                <div class="d-flex align-items-center gap-2">
        ...
        <form method="GET" action="{{ route('reports.department-giving') }}" class="card mb-4 border-0 shadow-sm"
            id="filtersForm">
            <!-- Filter Header -->
        ...
        @if(isset($combinedByPurpose) && !empty($combinedByPurpose))
            <div class="card mb-4">
                <div class="card-header report-header-warning py-2">
                    ...
                    <small class="text-white" style="text-shadow: 0 1px 2px rgba(0,0,0,0.3); opacity: 0.95;">This section
                        combines Pledges, Offerings, and Donations that share the same purpose</small>
                </div>
                <div class="card-body">
                                ...
                                @foreach($combinedByPurpose as $purpose => $data)
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-end">
                                            ...
                                            <br>
                                            <small class="text-muted">of {{ number_format($data['pledges']['total_pledged'], 0) }}
                                                pledged</small>
                                        </td>
                                        ...
                                        <td class="text-end">
                                            <span
                                                class="badge bg-{{ $data['pledges']['outstanding'] > 0 ? 'warning' : 'success' }}">
                            ...
                            @forelse($pledgeTypes as $pledge)
                                <tr>
                                    ...
                                    <td class="text-end">
                                        ...
                                        @endphp
                                        <span
                                            class="badge {{ $completionRate >= 100 ? 'bg-success' : ($completionRate >= 75 ? 'bg-warning' : 'bg-danger') }}">
