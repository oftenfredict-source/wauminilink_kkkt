        ...
        <div class="card shadow-lg border-0 rounded-4 overflow-hidden">
            <div
                ...
                <div class="mt-3 mt-md-0">
                    <a href="{{ route('members.index') }}" class="btn btn-outline-light btn-sm shadow-sm"><i
                ...
                <form id="addMemberForm" action="{{ route('members.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div id="step1">
                        <div class="row g-4 mb-3">
                            ...
                            <div class="col-md-4" id="temporaryMembershipDurationWrapper" style="display:none;">
                                <div class="row g-2">
                                    <div class="col-6">
                                        <div class="form-floating">
                                            <input type="number" class="form-control" name="membership_duration_value"
                                                id="membership_duration_value" min="1" max="120" placeholder="3">
                                            <label for="membership_duration_value">Duration</label>
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="form-floating">
                                            <select class="form-select" name="membership_duration_unit"
                                                id="membership_duration_unit">
                        ...
                        <div class="row g-4 mb-4">
                            ...
                            <div class="col-md-4">
                                <div class="form-floating">
                                    <input type="text" class="form-control" name="working_area" id="working_area"
                        ...
                        <div class="border rounded-3 p-4 mb-4 bg-white shadow-sm">
                            ...
                            <div class="row g-4">
                                ...
                                <div class="col-md-4" id="baptismLocationWrapper" style="display:none;">
                                    <div class="form-floating">
                                        <input type="text" class="form-control" name="baptism_location"
                                            id="baptism_location" placeholder="Church name">
                                        <label for="baptism_location">Baptism Location/Church</label>
                                    </div>
                                </div>
                                <div class="col-md-4" id="baptizedByWrapper" style="display:none;">
                                    <div class="form-floating">
                                        <input type="text" class="form-control" name="baptized_by" id="baptized_by"
                                ...
                                <div class="col-md-4" id="baptismCertificateWrapper" style="display:none;">
                                    <div class="form-floating">
                                        <input type="text" class="form-control" name="baptism_certificate_number"
                                            id="baptism_certificate_number" placeholder="Certificate number">
                                        <label for="baptism_certificate_number">Baptism Certificate Number
                                            (Optional)</label>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div id="step2" style="display:none;">
                        ...
                        <div class="border rounded-3 p-4 mb-4 bg-white shadow-sm">
                            <h6 class="mb-3 text-danger fw-bold"><i class="fas fa-hand-holding-heart me-2"></i>Hali ya
                                Ustawi wa Jamii (Welfare Status)</h6>
                            <div class="row g-4">
                                <div class="col-md-4">
                                    <div class="form-floating">
                                ...
                                <div class="col-md-4">
                                    <div class="form-check form-switch pt-2">
                                        <input class="form-check-input" type="checkbox" id="disability_status"
                                            name="disability_status" value="1">
                                        <label class="form-check-label fw-bold" for="disability_status">Ana Ulemavu? (Has
                                            Disability?)</label>
                                    </div>
                                    <div id="disabilityTypeWrapper" class="mt-2" style="display:none;">
                                        <div class="form-floating">
                                            <input type="text" class="form-control" name="disability_type"
                                                id="disability_type" placeholder="Nature of disability">
                                ...
                                <div class="col-md-4">
                                    <div class="form-check form-switch pt-2">
                                        <input class="form-check-input" type="checkbox" id="vulnerable_status"
                                            name="vulnerable_status" value="1">
                                        <label class="form-check-label fw-bold" for="vulnerable_status">Hali Ngumu/Dhaifu?
                                            (Vulnerable?)</label>
                                    </div>
                                    <div id="vulnerableTypeWrapper" class="mt-2" style="display:none;">
                                        <div class="form-floating">
                                            <input type="text" class="form-control" name="vulnerable_type"
                                                id="vulnerable_type" placeholder="e.g. Poverty, Chronic Illness">
                    ...
                    <div id="step3" style="display:none;">
                        ...
                        <div class="border rounded-3 p-4 mb-4 bg-white shadow-sm">
                            ...
                            <div class="row g-4">
                                <div class="col-md-6">
                                    <div class="form-floating">
                                        <input type="text" class="form-control" name="neighbor_name" id="neighbor_name"
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating">
                                        <div class="input-group">
                                            <span class="input-group-text">+255</span>
                                            <input type="text" class="form-control" name="neighbor_phone"
                                                id="neighbor_phone" placeholder="744000000">
                                        </div>
                    ...
                    <div id="step4" style="display:none;">
                        ...
                        <div id="maritalStatusSection" class="border rounded-3 p-4 mb-4 bg-white shadow-sm">
                            ...
                            <div id="weddingInfoSection" style="display:none;">
                                <hr class="my-4">
                                <h6 class="mb-3 text-primary fw-bold"><i class="fas fa-ring me-2"></i>Wedding Information
                                </h6>
                                <div class="row g-4 mb-3">
                                    <div class="col-md-6">
                                        <div class="form-floating">
                            ...
                            <div id="spouseInfoSection" style="display:none;">
                                <hr class="my-4">
                                <h6 class="mb-3 text-primary fw-bold"><i class="fas fa-user me-2"></i>Spouse Information
                                </h6>
                                <div class="row g-4 mb-3">
                                    <div class="col-md-4">
                                        <div class="form-floating">
                                ...
                                <div class="row g-4 mb-3" id="spouseCampusCommunityFields" style="display:none;">
                                    <div class="col-md-6">
                                        <div class="form-floating">
                                            ...
                                            <label for="spouse_campus_id">Spouse Campus/Branch <span
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-floating">
                                            ...
                                            <label for="spouse_community_id">Spouse Fellowship (Jumuiya) <span
                                                    class="text-danger">*</span></label>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-floating">
                                            <input type="text" class="form-control" name="spouse_envelope_number"
                                                id="spouse_envelope_number" placeholder="e.g. 111">
                                            <label for="spouse_envelope_number">Spouse Envelope Number <span
                                                    class="text-danger">*</span></label>
                                        </div>
                                        <small class="text-muted ms-1">Unique number within the fellowship (Jumuiya)</small>
                                    </div>
                                ...
                                <hr class="my-3">
                                <h6 class="mb-3 text-primary fw-bold"><i class="fas fa-tint me-2"></i>Spouse Baptism
                                    Information</h6>
                                <div class="row g-4 mb-3">
                                    <div class="col-md-4">
                                        <div class="form-floating">
                                            <select class="form-select" name="spouse_baptism_status"
                                                id="spouse_baptism_status">
                                                <option value="">Select...</option>
                                                <option value="baptized">Baptized</option>
                                                <option value="not_baptized">Not Baptized</option>
                                            </select>
                                    ...
                                    <div class="col-md-4" id="spouseBaptismDateWrapper" style="display:none;">
                                        <div class="form-floating">
                                            <input type="date" class="form-control" name="spouse_baptism_date"
                                    ...
                                    <div class="col-md-4" id="spouseBaptismLocationWrapper" style="display:none;">
                                        <div class="form-floating">
                                            <input type="text" class="form-control" name="spouse_baptism_location"
                                                id="spouse_baptism_location" placeholder="Church name">
                                    ...
                                    <div class="col-md-4" id="spouseBaptizedByWrapper" style="display:none;">
                                        <div class="form-floating">
                                            <input type="text" class="form-control" name="spouse_baptized_by"
                                                id="spouse_baptized_by" placeholder="Pastor name">
                                    ...
                                    <div class="col-md-4" id="spouseBaptismCertificateWrapper" style="display:none;">
                                        <div class="form-floating">
                                            <input type="text" class="form-control" name="spouse_baptism_certificate_number"
                                                id="spouse_baptism_certificate_number" placeholder="Certificate number">
                                            <label for="spouse_baptism_certificate_number">Spouse Baptism Certificate Number
                                                (Optional)</label>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <hr class="my-3">
                                <h6 class="mb-3 text-danger fw-bold"><i class="fas fa-hand-holding-heart me-2"></i>Spouse
                                    Welfare Status</h6>
                                <div class="row g-4 mb-3">
                                    <div class="col-md-6">
                                        <div class="form-floating">
                                            <select class="form-select" name="spouse_orphan_status"
                                                id="spouse_orphan_status">
                                                <option value="not_orphan">Si Yatima (Not Orphan)</option>
                                                <option value="father_deceased">Baba amefariki (Father Deceased)</option>
                                                <option value="mother_deceased">Mama amefariki (Mother Deceased)</option>
                                                <option value="both_deceased">Wote wamefariki (Both Deceased)</option>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-check form-switch pt-2">
                                            <input class="form-check-input" type="checkbox" id="spouse_disability_status"
                                                name="spouse_disability_status" value="1">
                                            <label class="form-check-label fw-bold" for="spouse_disability_status">Spouse
                                                Ana Ulemavu? (Has Disability?)</label>
                                        </div>
                                        <div id="spouseDisabilityTypeWrapper" class="mt-2" style="display:none;">
                                            <div class="form-floating">
                                                <input type="text" class="form-control" name="spouse_disability_type"
                                                    id="spouse_disability_type" placeholder="Nature of disability">
                        ...
                        <div class="border rounded-3 p-4 mb-4 bg-white shadow-sm" id="guardianSection"
                            style="display:none;">
                            <h6 class="mb-3 text-warning fw-bold"><i class="fas fa-user-shield me-2"></i>Guardian /
                                Responsible Person Information</h6>
                            <div class="row g-4">
                                <div class="col-md-4">
                                    <div class="form-floating">
                                ...
                                <div class="col-md-4">
                                    <div class="form-floating">
                                        <input type="text" class="form-control" name="guardian_relationship"
                                            id="guardian_relationship" placeholder="e.g., Father, Mother">
                        ...
                        <div class="border rounded-3 p-4 mb-4 bg-white shadow-sm" id="childrenSection">
                            ...
                            <div class="mb-3">
                                <div class="form-floating">
                                    <input type="number" class="form-control" name="children_count" id="children_count"
                                        min="0" value="0" placeholder="Enter number">
                                    <label for="children_count">Number of Children</label>
                                </div>
                                <small class="text-muted">Enter the number of children you want to register (0 if no
                                    children)</small>
                            </div>
                            <div id="childrenFields">
                                <div class="alert alert-info">
                                    <i class="fas fa-info-circle me-2"></i>Enter the number of children above to add their
                                    information.
                                </div>
                            </div>
                        </div>
                    ...
                    <div id="step5" style="display:none;">
                        <div class="alert alert-info mb-4">
                            ...
                            <p>Please review all the information you have entered. Click "Submit" to complete the
                                registration, or "Back" to make changes.</p>
                        </div>
                            ...
                            <div class="card-body">
                                <div class="form-check">
                                    ...
                                    <label class="form-check-label" for="previewMode">
                                        <i class="fas fa-eye me-1"></i><strong>Preview/Test Mode</strong> - Validate form
                                        without saving to database
                                    </label>
                                    <small class="text-muted d-block mt-1">Check this box to test the form submission and
                                        validation without actually saving data to the database.</small>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="d-flex justify-content-between">
                            <button type="button" class="btn btn-outline-secondary btn-lg px-4 shadow-sm prev-step"
                                id="prevStep5"><i class="fas fa-arrow-left me-1"></i>Back</button>
                            <button type="submit" class="btn btn-success btn-lg px-4 shadow-sm" id="submitBtn"><i
                ...
                if (childrenCount) {
                    ...
                    if (childrenContainer) {
                        ...
                        childrenContainer.addEventListener('change', function (e) {
                            ...
                            // Handle child date of birth change to update envelope required indicator
                            if (e.target.name && e.target.name.includes('[date_of_birth]')) {
