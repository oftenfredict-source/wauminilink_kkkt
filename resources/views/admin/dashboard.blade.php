...
@section('content')
    ...
    <div class="container-fluid px-4">
        ...
        <div class="row mb-3">
            <div class="col-12">
                <div class="card border-0 shadow-sm dashboard-header" style="background:#940000;">
                    <div class="card-body text-white py-2 px-3">
                        <div class="d-flex align-items-center justify-content-between flex-wrap gap-3">
                            <div class="d-flex align-items-center gap-3">
                                ...
                                <div class="lh-sm">
                                    <h5 class="mb-0 fw-semibold" style="color: white !important;">
                                        {{ autoTranslate('Administrator Dashboard') }}</h5>
                                    <small
                                        style="color: white !important;">{{ autoTranslate('System monitoring and management') }}</small>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                    {{ autoTranslate('Active Sessions') }}</div>
                        ...
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                <div class="text-xs font-weight-bold text-info text-uppercase mb-1">
                                    {{ autoTranslate('Total Activities') }}</div>
                                <div class="h5 mb-0 font-weight-bold text-gray-800">
                                    {{ number_format($stats['total_activities']) }}</div>
                            </div>
                            <div class="col-auto">
                        ...
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">
                                    {{ autoTranslate("Today's Activities") }}</div>
                ...
                <div class="card shadow mb-4">
                    <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                        ...
                        <a href="{{ route('admin.activity-logs') }}"
                            class="btn btn-sm btn-primary">{{ autoTranslate('View All') }}</a>
                    </div>
                    <div class="card-body">
                                    ...
                                    @empty
                                        <tr>
                                            <td colspan="4" class="text-center text-muted">
                                                {{ autoTranslate('No activities found') }}</td>
                                        </tr>
                                    @endforelse
                                </tbody>
                            </table>
                                ...
                                <div class="d-flex justify-content-between align-items-start">
                                    <div>
                                        ...
                                        <span class="badge badge-secondary"
                                            style="font-size: 0.75em;">{{ ucfirst($session->role) }}</span>
                                    </div>
        ...
        <div class="row">
                ...
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                        <h6 class="m-0 font-weight-bold text-primary">
                            {{ autoTranslate('Activity by Action (Last 7 Days)') }}</h6>
                    </div>
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-sm">
            ...
            <div class="col-lg-6 mb-4">
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                        <h6 class="m-0 font-weight-bold text-primary">{{ autoTranslate('Top Active Users (Last 7 Days)') }}
                        </h6>
                    </div>
                    <div class="card-body">
                        <div class="table-responsive">
                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-3 mb-2">
                                <a href="{{ route('departments.index') }}" class="btn btn-outline-primary btn-block">
                                    <i class="fas fa-layer-group"></i> {{ autoTranslate('Church Departments') }}
                                </a>
                            </div>
                            <div class="col-md-3 mb-2">
